<html lang="en-US">
	<head>
    	...
    	<meta name="title" property="og:title" content="Spider" />
    	<meta
    		name="Keywords"
    	...
    	<meta
    		...
    		content="Spider offers free online tutorials, references and exercises in all the major languages of the web. Covering popular subjects like HTML, CSS, JavaScript, Python, SQL, Java, and many, many more." />
    	...
    	<link
    		rel="preload"
    		href="/lib/fonts/source-code-pro-v14-latin-regular.woff2"
    		as="font"
    		type="font/woff2"
    		crossorigin="" />
    	<link
    		rel="preload"
    		href="/lib/fonts/roboto-mono-v13-latin-500.woff2"
    		as="font"
    		type="font/woff2"
    		crossorigin="" />
    	<link
    		rel="preload"
    		href="/lib/fonts/source-sans-pro-v14-latin-700.woff2"
    		as="font"
    		type="font/woff2"
    		crossorigin="" />
    	<link
    		rel="preload"
    		href="/lib/fonts/source-sans-pro-v14-latin-600.woff2"
    		as="font"
    		type="font/woff2"
    		crossorigin="" />
    	<link
    		rel="preload"
    		href="/lib/fonts/SourceSansPro-Regular.woff2"
    		as="font"
    		type="font/woff2"
    		crossorigin="" />
    	<link
    		rel="preload"
    		href="/lib/fonts/freckle-face-v9-latin-regular.woff2"
    		as="font"
    		type="font/woff2"
    		crossorigin="" />
    	...
    	<script
    		...
    		async=""
    		charset="utf-8"
    		src="https://www.gstatic.com/recaptcha/releases/A7KpaEASfhDcK0nXxgQEyyYv/recaptcha__en.js"
    		crossorigin="anonymous"
    		integrity="sha384-DMJucfgjcmtc4a8x9gFfPgwoWXK+1qozk7K/wTFGVtduYs3wg2BI8Z5lrJXZV+iE"></script>
    	<script
    		async=""
    		src="https://www.googletagmanager.com/gtm.js?id=GTM-KTCFC3S"></script>
    	<script
    		data-cfasync="false"
    		data-no-optimize="1"
    		...
    		((window.FAST_CMP_OPTIONS = {
    			...
    			displaySynchronous: !1,
    			publisherName: "W3Schools",
    			publisherLogo: function (r) {
    			...
    			(function () {
    							...
    							((window.FAST_CMP_T0 = Date.now()),
    								...
    								(r.exports = {
    									...
    									handler: function () {
    										...
    										if (!r.length)
    											return Object.values(window.FAST_CMP_QUEUE);
    										"ping" === r[0]
    											? "function" == typeof r[2] &&
    												r[2]({
    													cmpLoaded: !1,
    											...
    											: (window.FAST_CMP_QUEUE[window.FAST_CMP_QUEUE_ID++] =
    													r);
    									},
    								}));
    						},
    				...
    				if ("custom" !== c.FAST_CMP_HANDLER)
    					for (var s in (r
    						? ((c.__tcfapi = a.handler), (c.FAST_CMP_HANDLER = a.name))
    						: ((function r() {
    								var e = c.document,
    									a = !!c.frames[i];
    								if (!a)
    							...
    							(c.__tcfapi = a.handler),
    							(c.FAST_CMP_HANDLER = a.name),
    							c.addEventListener(
    								"message",
    								function (t) {
    									...
    									var n = "object" === e(r) ? r.__tcfapiCall : null;
    									n &&
    										window.__tcfapi(
    											n.command,
    											n.version,
    					...
    					window.FAST_CMP_QUEUE || {}))
    						c.__tcfapi.apply(null, window.FAST_CMP_QUEUE[s]);
    			})());
    	</script>
    	<script
    		data-cfasync="false"
    		...
    		async=""
    		charset="UTF-8"
    		src="https://static.fastcmp.com/fast-cmp-stub.js"></script>
    	<style>
    		#nav_tutorials,
    		#nav_references,
    		#nav_certified,
...
background-position: 90% 60%, center center;_/
padding-top: 80px;
padding-bottom: 80px;
}
/_
...
\*/
    		...
    		#bgcodeimg2 {
    			background: #282a35
    				url("https://www.w3schools.com/spaces/files/priscilla-du-preez-XkKCui44iM0-unsplash.921aa0c0.webp")
    		...
    		.learntocodeh4 a:hover,
    		.learntocodeh4 a:active {
    			color: #fff4a3;
    		}
    		.learntocodecontent {
    			padding-left: 90px;
    	...
    	<style id="dashboard-lite-style">
    		...
    		.dlw-row-mode .dlw-badge {
    			width: 76px;
    			height: 76px;
    		}
    		.dlw-grid-mode .dlw-badge {
    			width: 40px;
    			height: 40px;
    		}
    		.dlw-col-mode .dlw-badge {
    			width: 32px;
    			height: 32px;
    		}
    		.dlw-ring {
    		...
    		.dlw-stack-mode .dlw-stage {
    			flex-direction: row;
    			flex-wrap: wrap;
    			gap: 12px;
    		}
    		.dlw-stack-mode .dlw-t-avatar,
    		.dlw-stack-mode .dlw-t-streak {
    		...
    		.dlw-stack-mode .dlw-t-league,
    		.dlw-stack-mode .dlw-t-continue,
    		.dlw-stack-mode .dlw-t-practice {
    			flex: 1 1 100%;
    		}
    		.dlw-stack-mode .dlw-t-league .dlw-tile-body,
    		.dlw-stack-mode .dlw-t-continue .dlw-tile-body,
    		.dlw-stack-mode .dlw-t-practice .dlw-tile-body {
    			flex: 1;
    		}
    		.dlw-grid-mode .dlw-t-practice,
    		.dlw-col-mode .dlw-t-practice {
    			display: none !important;
    		}
    		.dlw-stack-mode .dlw-t-continue {
    			padding-top: 24px;
    		}
    		.dlw-stack-mode .dlw-avatar {
    			width: 64px;
    			height: 64px;
    		}
    		.dlw-stack-mode .dlw-tile-ico svg {
    			width: 40px;
    			height: auto;
    		}
    		.dlw-row-mode .dlw-stage {
    			display: grid;
    		...
    		.dlw-row-mode .dlw-tile-body {
    			display: flex;
    			flex-direction: column;
    			gap: 5px;
    		}
    		.dlw-row-mode .dlw-t-avatar {
    			grid-column: 1;
    			grid-row: 1;
    		}
    		.dlw-row-mode .dlw-t-streak {
    			grid-column: 1;
    			grid-row: 2;
    		}
    		.dlw-row-mode .dlw-t-league,
    		.dlw-row-mode .dlw-t-continue,
    		.dlw-row-mode .dlw-t-practice {
    			grid-row: 1 / span 2;
    		}
    		.dlw-row-mode .dlw-t-avatar,
    		.dlw-row-mode .dlw-t-streak {
    		...
    		.dlw-row-mode .dlw-t-avatar .dlw-avatar {
    			width: 48px;
    			height: 48px;
    		}
    		.dlw-row-mode .dlw-t-avatar .dlw-mood {
    			width: 18px;
    			height: 18px;
    		}
    		.dlw-row-mode .dlw-t-avatar .dlw-title {
    			font-size: 13px;
    		}
    		.dlw-row-mode .dlw-t-streak .dlw-tile-ico svg {
    			width: 34px;
    		}
    		.dlw-row-mode .dlw-t-streak .dlw-streak-num {
    			font-size: 28px;
    		}
    		.dlw-row-mode .dlw-t-avatar .dlw-sub,
    		.dlw-row-mode .dlw-t-streak .dlw-sub {
    			font-size: 11px;
    		}
    		.dlw-row-mode .dlw-tile-ico svg {
    			width: 52px;
    			height: auto;
    		}
    		.dlw-row-mode .dlw-lang-ico {
    			width: 56px;
    			height: 56px;
    		}
    		.dlw-row-mode .dlw-title {
    			font-size: 19px;
    		}
    		.dlw-row-mode .dlw-sub {
    			font-size: 14px;
    		}
    		.dlw-row-mode .dlw-ring {
    			width: 44px;
    			height: 44px;
    		}
    		.dlw-row-mode .dlw-ring svg {
    			width: 44px;
    			height: 44px;
    		}
    		.dlw-row-mode .dlw-ring-pct {
    			font-size: 11px;
    		}
    		.dlw-grid-mode .dlw-stage {
    			flex-direction: row;
    			flex-wrap: wrap;
    			align-content: stretch;
    		}
    		.dlw-grid-mode .dlw-tile {
    		...
    		.dlw-grid-mode .dlw-avatar {
    			width: 44px;
    			height: 44px;
    		}
    		.dlw-grid-mode .dlw-tile-ico svg {
    			width: 34px;
    			height: auto;
    		}
    		.dlw-grid-mode .dlw-ring {
    			display: none;
    		}
    		.dlw-grid-mode .dlw-pickup {
    			display: none;
    		}
    		.dlw-col-mode .dlw-stage {
    			flex-direction: column;
    		}
    		.dlw-col-mode .dlw-tile {
    			flex: 1;
    			flex-direction: row;
    			align-items: center;
    			gap: 10px;
    		...
    		.dlw-col-mode .dlw-tile-body {
    			flex: 1;
    		}
    		.dlw-col-mode .dlw-avatar {
    			width: 34px;
    			height: 34px;
    		}
    		.dlw-col-mode .dlw-lang-ico {
    			width: 34px;
    			height: 34px;
    		}
    		.dlw-col-mode .dlw-tile-ico svg {
    			width: 26px;
    			height: auto;
    		}
    		.dlw-col-mode .dlw-streak-num {
    			font-size: 20px;
    		}
    		.dlw-col-mode .dlw-title {
    			font-size: 13px;
    		}
    		.dlw-col-mode .dlw-sub {
    			font-size: 11px;
    		}
    		.dlw-col-mode .dlw-action,
    		.dlw-col-mode .dlw-ring,
    		.dlw-col-mode .dlw-pickup {
    			display: none;
    		}
    		.dlw-col-mode a.dlw-tile::after {
    			content: "\203A";
    			color: #04aa6d;
    			font-size: 22px;
    			font-weight: 700;
    		...
    		.dlw-caro {
    			...
    			min-height: 150px;
    			overflow: hidden;
    			background: linear-gradient(180deg, #30323f, #23242f);
    		}
    		.dlw-caro-lock {
    			position: absolute;
    			top: 8px;
    		...
    		.dlw-combo .dlw-vis-num {
    			font-size: 34px;
    		}
    		.dlw-combo-head .dlw-vis-bolt svg {
    			width: 26px;
    			height: 30px;
    		}
    		.dlw-combo .dlw-slide-cap b {
    			font-size: 16px;
    		}
    		.dlw-combo .dlw-slide-cap span {
    			font-size: 12px;
    			margin-top: 2px;
    		}
    		.dlw-combo-stats {
    		...
    		.dlw-vis-link:hover ~ .dlw-slide-cap .dlw-cap-link {
    			text-decoration: underline;
    		}
    		.dlw-slide-vis {
    			display: flex;
    		...
    		.dlw-vis-league .dlw-vis-hi {
    			width: 80px;
    			height: 80px;
    			filter: drop-shadow(0 0 10px rgba(150, 120, 255, 0.7));
    		}
    		.dlw-vis-arrow {
    			color: #6b6f7d;
    			font-size: 24px;
    		...
    		.dlw-col-mode .dlw-vis-spaces-img {
    			width: 124px;
    		}
    		.dlh-anon .dlw-vis-practice-img,
    		.dlh-frozen .dlw-vis-practice-img,
    		.dlh-anon .dlw-vis-spaces-img,
    		.dlh-frozen .dlw-vis-spaces-img {
    			width: auto;
    			max-width: 240px;
    			max-height: 140px;
    		}
    		.dlw-vis-practice-img {
    			width: 250px;
    			height: auto;
    			filter: drop-shadow(0 10px 22px rgba(0, 0, 0, 0.5));
    		}
    		.dlw-col-mode .dlw-vis-practice-img {
    			width: 124px;
    		}
    		.dlw-caro-dots {
    			position: absolute;
    		...
    		.dlw-anon-signin a:hover {
    			text-decoration: underline;
    		}
    		.dlw-cta-s {
    			display: none;
    		}
    		.dlw-row-mode .dlw-anon2 {
    			flex-direction: row;
    		}
    		.dlw-row-mode .dlw-anon-bar {
    			flex: 0 0 320px;
    			justify-content: center;
    			padding: 20px 26px;
    		}
    		.dlw-row-mode .dlw-slide-cap b {
    			font-size: 18px;
    		}
    		.dlw-grid-mode .dlw-anon-bar {
    			padding: 12px;
    			gap: 6px;
    		}
    		.dlw-grid-mode .dlw-anon-or {
    			display: none;
    		}
    		.dlw-col-mode .dlw-anon-bar {
    			padding: 10px;
    			gap: 7px;
    		}
    		.dlw-col-mode .dlw-anon-or {
    			display: none;
    		}
    		.dlw-col-mode .dlw-cta-l {
    			display: none;
    		}
    		.dlw-col-mode .dlw-cta-s {
    			display: inline;
    		}
    		.dlw-col-mode .dlw-social {
    			width: 30px;
    			height: 30px;
    		}
    		.dlw-col-mode .dlw-slide-cap b {
    			font-size: 13px;
    		}
    		.dlw-col-mode .dlw-slide-cap span {
    			display: none;
    		}
    		.dlw-col-mode .dlw-vis-num {
    			font-size: 26px;
    		}
    		.dlh,
    		.dlh *,
    ...
    <body
    	...
    	<div id="top-nav-bar" class="classic">
    		<div id="pagetop" class="w3-bar notranslate w3-white">
    			...
    			<div class="tnb-right-section">
    				...
    				<div
    					id="tnb-login-btn"
    					class="user-anonymous tnb-login-btn w3-bar-item w3-btn bar-item-hover w3-right w3s-green ga-top ga-top-login"
      ...
      >
        Sign Up
    				...
    				<a
    					id="tnb-user-profile"
    					href="https://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fwww.w3schools.com%2F"
            ...
            fill="black" />
    					...
    					<svg
    						...
    						<path
    							...
    							fill="none"
    							d="M 26 15 A 20 20 0 0 0 26 15"></path>
    					</svg>
      ...
      -->
    				...
    				<a
    					...
    					class="user-anonymous tnb-certificates-btn tnb-right-side-btn w3-bar-item w3-button w3-right w3-white ga-top ga-top-certificates"
    				...
    				<a
    					...
    					class="user-anonymous tnb-upgrade-btn tnb-right-side-btn w3-bar-item w3-button w3-right w3-white ga-top ga-top-plus"
    				...
    				<a
    					...
    					class="user-anonymous tnb-for-teachers tnb-right-side-btn w3-bar-item w3-button w3-right w3-white ga-top ga-top-teachers"
    				...
    				<a
    					...
    					class="user-anonymous tnb-spaces-btn tnb-right-side-btn w3-bar-item w3-button w3-right w3-white ga-top ga-top-spaces"
    				...
    				<a
    					...
    					class="user-anonymous tnb-practice-btn tnb-right-side-btn w3-bar-item w3-button w3-right w3-white ga-top ga-top-practice"
    		...
    		<div id="dropdown-nav-outer-wrapper">
    			<div id="dropdown-nav-inner-wrapper">
    				<nav
    					...
    					<div class="tutnav-wrap">
    						...
    						<div id="tutorials_list">
    							<div id="tutnav_title_area"></div>
    							<div id="tutnav_current_topic" style="display: none"></div>
    								<div class="certnav-ref-row">
    									<div class="certnav-ref-card">
    										<div class="certnav-ref-card-text">
    											<h2 class="certnav-ref-card-title">
    												Become
    												<span class="certnav-ref-topic">W3Schools</span>
    												Certified
    											</h2>
    											<p class="certnav-ref-card-desc">
    												Get certified, and earn a credential that proves your
    												skills.
    											</p>
    											<p class="certnav-ref-price">From $95</p>
    											<p class="certnav-ref-access">
    												Includes exam, course materials, exercises, and one
    												year of the
    												<a
    													href="javascript:void(0)"
    													onclick="
    														event.preventDefault();
    														TopNavBar.handleRedirect(
    															'TopNavBar.initDropdownNavs.tutorials.heroPlan',
    											...
    											<a
    												class="certnav-ref-btn"
    												href="javascript:void(0)"
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.tutorials.defaultCert',
    														'https://campus.w3schools.com/collections/course-catalog',
    													);
    												"
    												>Get W3Schools Certified</a
    											>
    										</div>
    									</div>
    									<div class="certnav-preview">
    										<svg
    											class="certnav-preview-svg"
    											xmlns="http://www.w3.org/2000/svg"
    											viewBox="0 0 560 400"
    											role="img"
    											aria-label="W3Schools Certificate preview">
    											<rect
    												x="8"
    												y="8"
    												width="544"
    											...
    											<text
    												...
    												font-size="13"
    												fill="#475569">
    												has passed the W3Schools Certification exam and is
    												hereby declared a
    											</text>
    											...
    											<text
    												...
    												font-size="12"
    												fill="#64748b">
    												The candidate has passed the exam at the Professional
    												level.
    											</text>
    											<text
    												x="40"
    							...
    							<div class="tutnav-topics-scroll">
    								<div class="tutnav-grid" id="tutnav_grid">
    									<a
    										class="tutnav-card"
    										data-name="html"
    										data-category="html_and_css"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    												height="40"
    										...
    										<h4 class="tutnav-card-title">HTML</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">CSS</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">JavaScript</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">SQL</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<path
    													d="M15.885 2.1c-7.1 0-6.651 3.07-6.651 3.07v3.19h6.752v1H6.545S2 8.8 2 16.005s4.013 6.912 4.013 6.912H8.33v-3.361s-.13-4.013 3.9-4.013h6.762s3.772.06 3.772-3.652V5.8s.572-3.712-6.842-3.712zm-3.732 2.137a1.214 1.214 0 1 1 0 2.428 1.214 1.214 0 0 1 0-2.428z"
    													fill="url(#tut-py-b)"></path>
    												<path
    													d="M16.085 29.91c7.1 0 6.651-3.08 6.651-3.08v-3.18h-6.751v-1h9.47S30 23.158 30 15.995s-4.013-6.912-4.013-6.912H23.64v3.361s.13 4.013-3.9 4.013h-6.765S9.2 16.4 9.2 20.112v6.091s-.572 3.712 6.842 3.712zm3.732-2.147a1.214 1.214 0 1 1 0-2.428 1.214 1.214 0 0 1 0 2.428z"
    													fill="url(#tut-py-y)"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Python</h4>
    										<p class="tutnav-card-desc">
    											Popular programming language for web, data &amp; AI
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="java"
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<path
    													...
    													fill="#E76F00"></path>
    												<path
    													d="M233.364 295.442s9.767 8.047-10.757 14.273c-39.026 11.823-162.432 15.393-196.714.471-12.323-5.36 10.787-12.8 18.056-14.362 7.581-1.644 11.914-1.337 11.914-1.337-13.705-9.655-88.583 18.957-38.034 27.15 137.853 22.356 251.292-8.865 215.535-26.195M88.9 190.48s-62.771 14.91-22.228 20.323c17.118 2.292 51.243 1.774 83.03-.89 25.978-2.19 52.063-6.85 52.063-6.85s-9.16 3.923-15.787 8.448c-63.744 16.765-186.886 8.966-151.435-8.183 29.981-14.492 54.358-12.848 54.358-12.848M201.506 253.422c64.8-33.672 34.839-66.03 13.927-61.67-5.126 1.066-7.411 1.99-7.411 1.99s1.903-3.34 5.537-4.79c41.37-14.545 73.187 42.897-13.355 65.647 0 0 .98-.88 1.302-1.177"
    													fill="#5382A1"></path>
    												<path
    													d="M162.439.371s35.887 35.9-34.037 91.101c-56.071 44.282-12.786 69.53-.023 98.377-32.73-29.53-56.75-55.526-40.635-79.72C111.395 74.612 176.918 57.394 162.439.37"
    													fill="#E76F00"></path>
    												<path
    													d="M95.268 344.665c62.199 3.982 157.712-2.209 159.974-31.64 0 0-4.348 11.158-51.404 20.018-53.088 9.99-118.564 8.824-157.399 2.421 0 0 7.95 6.58 48.83 9.201"
    													fill="#5382A1"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Java</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">C</h4>
    										<p class="tutnav-card-desc">
    											Powerful low-level programming
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="c++"
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">PHP</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.41 0-.783.093-1.106.278-1.375.793-1.683 3.264-.973 6.365C1.98 8.917 0 10.42 0 12.004c0 1.59 1.99 3.097 5.043 4.03-.704 3.113-.39 5.588.988 6.38.32.187.69.275 1.102.275 1.345 0 3.107-.96 4.888-2.624 1.78 1.654 3.542 2.603 4.887 2.603.41 0 .783-.09 1.106-.275 1.374-.792 1.683-3.263.973-6.365C22.02 15.096 24 13.59 24 12.004c0-1.59-1.99-3.097-5.043-4.032.704-3.11.39-5.587-.988-6.38-.318-.184-.688-.277-1.092-.278zm-.005 1.09v.006c.225 0 .406.044.558.127.666.382.955 1.835.73 3.704-.054.46-.142.945-.25 1.44-.96-.236-2.006-.417-3.107-.534-.66-.905-1.345-1.727-2.035-2.447 1.592-1.48 3.087-2.292 4.105-2.295zm-9.77.02c1.012 0 2.514.808 4.11 2.28-.686.72-1.37 1.537-2.02 2.442-1.107.117-2.154.298-3.113.538-.112-.49-.195-.964-.254-1.42-.23-1.868.054-3.32.714-3.707.19-.09.4-.127.563-.132zm4.882 3.05c.455.468.91.992 1.36 1.564-.44-.02-.89-.034-1.345-.034-.46 0-.915.01-1.36.034.44-.572.895-1.096 1.345-1.565zM12 8.1c.74 0 1.477.034 2.202.093.406.582.802 1.203 1.183 1.86.372.64.71 1.29 1.018 1.946-.308.655-.646 1.31-1.013 1.95-.38.66-.773 1.288-1.18 1.87-.728.063-1.466.098-2.21.098-.74 0-1.477-.035-2.202-.093-.406-.582-.802-1.204-1.183-1.86-.372-.64-.71-1.29-1.018-1.946.303-.657.646-1.313 1.013-1.954.38-.66.773-1.286 1.18-1.868.728-.064 1.466-.098 2.21-.098zm-3.635.254c-.24.377-.48.763-.704 1.16-.225.39-.435.782-.635 1.174-.265-.656-.49-1.31-.676-1.947.64-.15 1.315-.283 2.015-.386zm7.26 0c.695.103 1.365.23 2.006.387-.18.632-.405 1.282-.66 1.933-.2-.39-.41-.783-.64-1.174-.225-.392-.465-.774-.705-1.146zm3.063.675c.484.15.944.317 1.375.498 1.732.74 2.852 1.708 2.852 2.476-.005.768-1.125 1.74-2.857 2.475-.42.18-.88.342-1.355.493-.28-.958-.646-1.956-1.1-2.98.45-1.017.81-2.01 1.085-2.962zm-13.395.004c.278.96.645 1.957 1.1 2.98-.45 1.017-.812 2.01-1.086 2.964-.484-.15-.944-.318-1.375-.498-1.732-.74-2.852-1.708-2.852-2.476.005-.768 1.125-1.74 2.857-2.474.42-.18.88-.342 1.356-.494zm11.678 4.28c.265.657.49 1.312.676 1.948-.64.15-1.315.283-2.015.386-.24-.375-.48-.762-.705-1.158-.225-.39-.435-.783-.636-1.174.265.655.49 1.31.68 1.998zm-9.945.02c.19-.689.41-1.342.679-1.998-.2.392-.41.783-.64 1.174-.225.396-.465.783-.704 1.158-.695-.103-1.365-.23-2.006-.386.18-.636.405-1.29.66-1.943zM17.92 16.32c.112.493.2.968.254 1.423.23 1.868-.054 3.32-.714 3.708-.147.09-.338.128-.563.128-1.012 0-2.514-.807-4.11-2.28.686-.72 1.37-1.536 2.02-2.44 1.107-.118 2.154-.3 3.113-.54zm-11.83.01c.96.234 2.006.415 3.107.532.66.905 1.345 1.727 2.035 2.446-1.595 1.483-3.092 2.295-4.11 2.295-.22-.005-.406-.05-.553-.132-.666-.38-.955-1.834-.73-3.703.054-.46.142-.944.25-1.438zm4.56.64c.44.02.89.034 1.345.034.46 0 .915-.01 1.36-.034-.44.572-.895 1.095-1.345 1.565-.455-.47-.91-.993-1.36-1.565z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">React</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<path
    													fill="#4479A1"
    													d="M116.948 97.807c-6.863-.187-12.104.452-16.585 2.341-1.273.537-3.305.552-3.513 2.147.7.733.809 1.829 1.365 2.731 1.069 1.73 2.876 4.052 4.488 5.268 1.762 1.33 3.572 2.751 5.465 3.902 3.357 2.047 7.107 3.217 10.336 5.268 1.906 1.21 3.799 2.733 5.658 4.097.922.675 1.538 1.724 2.732 2.147v-.194c-.628-.8-.79-1.898-1.365-2.732l-2.537-2.537c-2.48-3.292-5.629-6.184-8.976-8.585-2.669-1.916-8.642-4.504-9.75-7.708l-.195-.195c1.906-.214 4.128-.898 5.854-1.367 2.93-.786 5.533-.583 8.561-1.365l4.097-1.171v-.78c-1.531-1.571-2.623-3.651-4.292-5.073-4.37-3.72-9.138-7.437-14.048-10.527-2.724-1.718-6.089-2.835-8.976-4.292-.971-.491-2.677-.746-3.318-1.559-1.517-1.932-2.342-4.382-3.513-6.633-2.449-4.717-4.859-9.868-7.023-14.829-1.479-3.384-2.44-6.721-4.293-9.75-8.86-14.569-18.396-23.358-33.169-32.002-3.144-1.838-6.929-2.563-10.919-3.513-2.145-.129-4.292-.26-6.44-.391-1.311-.546-2.673-2.149-3.902-2.927-4.894-3.092-17.448-9.817-21.072-.975-2.289 5.581 3.421 11.025 5.462 13.854 1.434 1.982 3.269 4.207 4.293 6.437.675 1.467.79 2.938 1.367 4.489 1.421 3.822 2.656 7.98 4.487 11.502.927 1.788 1.949 3.67 3.122 5.268.718.981 1.951 1.413 2.145 2.927-1.204 1.686-1.273 4.304-1.95 6.44-3.05 9.615-1.895 21.567 2.537 28.652 1.36 2.186 4.567 6.871 8.975 5.073 3.856-1.57 2.995-6.438 4.098-10.725.249-.972.096-1.689.585-2.341v.194l3.513 7.023c2.6 4.187 7.212 8.562 11.112 11.502 2.027 1.531 3.623 4.177 6.244 5.073v-.391h-.195c-.508-.791-1.288-1.115-1.952-1.755-1.525-1.48-3.221-3.312-4.487-4.975-3.559-4.82-6.703-10.1-9.556-15.609-1.369-2.672-2.561-5.622-3.707-8.39-.445-1.084-.44-2.727-1.364-3.318-1.263 1.958-3.126 3.542-4.098 5.854-1.561 3.696-1.762 8.204-2.341 12.878-.342.122-.19.038-.391.194-2.718-.655-3.672-3.452-4.683-5.853-2.554-6.07-3.029-15.842-.781-22.829.582-1.809 3.21-7.501 2.146-9.165-.508-1.666-2.184-2.63-3.121-3.903-1.161-1.574-2.319-3.646-3.124-5.464-2.09-4.731-3.066-10.035-5.267-14.828-1.053-2.284-2.832-4.585-4.293-6.634-1.617-2.252-3.429-3.912-4.683-6.635-.445-.968-1.051-2.518-.39-3.513.21-.671.507-.951 1.171-1.17 1.133-.873 4.286.29 5.462.779 3.129 1.3 5.741 2.538 8.39 4.294 1.271.844 2.559 2.475 4.097 2.927h1.756c2.747.631 5.824.195 8.39.975 4.532 1.399 8.592 3.582 12.292 5.855 11.246 7.102 20.441 17.21 26.697 29.433 1.011 1.942 1.45 3.794 2.341 5.854 1.798 4.153 4.063 8.426 5.853 12.488 1.786 4.048 3.526 8.13 6.05 11.502 1.327 1.772 6.451 2.723 8.78 3.708 1.632.689 4.307 1.409 5.854 2.34 3.071 1.836 6.051 4.034 8.975 6.05 1.461 1.01 5.969 3.21 6.244 5.073z"></path>
    												<path
    													fill="#4479A1"
    													d="M29.434 23.944c-1.453-.027-2.479.157-3.513.389v.196h.195c.683 1.402 1.888 2.307 2.731 3.513.65 1.337 1.27 2.674 1.952 4.01l.195-.195c1.212-.856 1.768-2.221 1.756-4.293-.484-.505-.555-1.135-.975-1.757-.556-.811-1.625-1.27-2.341-1.863z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">MySQL</h4>
    										<p class="tutnav-card-desc">
    											Query and manage databases
    										</p></a
    									><a
    										...
    										<h4 class="tutnav-card-title">Excel</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">DSA</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">W3.CSS</h4>
    										<p class="tutnav-card-desc">W3Schools CSS framework</p></a
    									><a
    										class="tutnav-card"
    										...
    										<h4 class="tutnav-card-title">Bootstrap 3</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Bootstrap 4</h4>
    										<p class="tutnav-card-desc">
    											Responsive CSS framework
    										</p></a
    									><a
    										...
    										<h4 class="tutnav-card-title">Bootstrap 5</h4>
    										<p class="tutnav-card-desc">
    											Responsive CSS framework
    										</p></a
    									><a
    										...
    										<h4 class="tutnav-card-title">Node.js</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.033 5.033 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 27.72 27.72 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.441.58-.804 1.004-1.089a4.494 4.494 0 0 1 1.47-.629 7.536 7.536 0 0 1 1.77-.201zm-10.14.71h4.853v1.535H11.9V20.1H9.868v-8.108H7.478V10.46h.87z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">TypeScript</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Django</h4>
    										<p class="tutnav-card-desc">Python web framework</p></a
    									><a
    										class="tutnav-card"
    										...
    										<h4 class="tutnav-card-title">PostgreSQL</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">jQuery</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">XML</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">NumPy</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M16.922 0h2.623v18.104h-2.623zm-4.126 12.94h2.623v2.57h-2.623zm0-7.037h2.623v5.446h-2.623zm0 11.197h2.623v5.446h-2.623zM4.456 5.896h2.622V18.1H4.456zm4.213 2.559h2.623v2.57H8.67zm0 4.151h2.623v2.57H8.67zM4.456 0h2.622v4.315H4.456zm0 19.68h2.622V24H4.456z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Pandas</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">How To</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M16.712 17.711H7.288l-1.204 2.916L12 24l5.916-3.373-1.204-2.916ZM14.692 0l7.832 16.855.814-12.856L14.692 0ZM9.308 0 .662 3.999l.814 12.856L9.308 0Zm-.405 13.93h6.198L12 6.396 8.903 13.93Z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Angular</h4>
    										<p class="tutnav-card-desc">Front-end web framework</p></a
    									><a
    										class="tutnav-card"
    										data-name="angularjs"
    										data-category="javascript"
    										...
    										<h4 class="tutnav-card-title">AngularJS</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.66 2.66c.645-.222 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.72.719-1.886.719-2.605 0-.538-.536-.67-1.32-.4-1.978l-2.48-2.48v6.53c.175.086.34.197.478.336.72.72.72 1.884 0 2.604-.72.719-1.884.719-2.604 0-.72-.72-.72-1.885 0-2.604.18-.18.39-.318.619-.412V9.305c-.228-.094-.44-.233-.619-.412-.544-.542-.676-1.338-.396-2.001L7.636 4.17 1.452 10.354c-.604.604-.604 1.582 0 2.186l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.604-.603.604-1.582-.002-2.187"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Git</h4>
    										<p class="tutnav-card-desc">Version control system</p></a
    									><a
    										class="tutnav-card"
    										data-name="mongodb"
    										data-category="backend"
    										...
    										<h4 class="tutnav-card-title">MongoDB</h4>
    										<p class="tutnav-card-desc">NoSQL document database</p></a
    									><a
    										class="tutnav-card"
    										data-name="asp"
    										data-category="backend"
    										...
    										<h4 class="tutnav-card-title">ASP</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M12 2a4 4 0 0 1 4 4v2a4 4 0 0 1-8 0V6a4 4 0 0 1 4-4z"></path>
    												<path
    													d="M16 16H8a4 4 0 0 0-4 4v1h16v-1a4 4 0 0 0-4-4z"></path>
    												<line x1="9" y1="13" x2="9" y2="16"></line>
    												<line x1="15" y1="13" x2="15" y2="16"></line>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">AI</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">R</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Go</h4>
    										<p class="tutnav-card-desc">
    											Fast and simple compiled language
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="kotlin"
    										...
    										<h4 class="tutnav-card-title">Kotlin</h4>
    										<p class="tutnav-card-desc">
    											Modern language for Android
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="swift"
    										...
    										<h4 class="tutnav-card-title">Swift</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0zM9.615 15.998c.175.645.156 1.248-.024 1.792l-.065.18c-.024.061-.052.12-.078.176-.14.29-.326.56-.555.81-.698.759-1.672 1.047-2.09.805-.45-.262-.226-1.335.584-2.19.871-.918 2.12-1.509 2.12-1.509v-.064zm9.064-9.648c-.476-1.834-3.546-2.435-6.456-1.413-1.742.612-3.623 1.574-4.98 2.83-1.614 1.494-1.87 2.795-1.764 3.34.376 1.926 3.055 3.184 4.152 4.127v.025c-.322.155-2.706 1.362-3.266 2.594-.597 1.317.095 2.263.556 2.39 1.428.393 2.897-.313 3.685-1.477.764-1.128.692-2.586.365-3.302.451-.128.977-.186 1.65-.101 1.9.233 2.274 1.478 2.2 2-.075.522-.482.81-.618.893-.136.083-.178.112-.166.174.017.09.083.087.204.068.166-.027 1.06-.43 1.098-1.408.052-1.254-1.146-2.652-3.258-2.615-.87.015-1.416.103-1.816.265a.367.367 0 00-.096-.1c-1.16-1.234-3.304-2.107-3.212-3.765.033-.603.248-2.19 4.103-4.117 3.158-1.577 5.684-1.143 6.121-.18.624 1.378-1.358 3.94-4.656 4.31-1.256.14-1.916-.347-2.08-.528-.172-.19-.198-.198-.262-.162-.104.06-.038.233 0 .336.098.265.498.738 1.18.972.6.207 2.063.32 3.83-.397 1.98-.803 3.527-3.04 3.076-4.91z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Sass</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M24,1.61H14.06L12,5.16,9.94,1.61H0L12,22.39ZM12,14.08,5.16,2.23H9.59L12,6.41l2.41-4.18h4.43Z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Vue</h4>
    										<p class="tutnav-card-desc">
    											Progressive JavaScript framework
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="generative_ai"
    										data-category="data_analytics"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    										...
    										<h4 class="tutnav-card-title">Gen AI</h4>
    										<p class="tutnav-card-desc">AI that creates content</p></a
    									><a
    										class="tutnav-card"
    										data-name="scipy"
    										data-category="data_analytics"
    										...
    										<h4 class="tutnav-card-title">SciPy</h4>
    										<p class="tutnav-card-desc">
    											Scientific computing with Python
    										</p></a
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M18 10h-1.26A8 8 0 109 20h9a5 5 0 000-10z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">AWS</h4>
    										<p class="tutnav-card-desc">Amazon cloud services</p></a
    									><a
    										class="tutnav-card"
    										...
    										<h4 class="tutnav-card-title">Cyber Security</h4>
    										<p class="tutnav-card-desc">
    											Web security fundamentals
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="data_science"
    										data-category="data_analytics"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    										...
    										<h4 class="tutnav-card-title">Data Science</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Intro to Programming</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Intro to HTML &amp; CSS</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Bash</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Rust</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Tools</h4>
    										<p class="tutnav-card-desc">Web developer tools</p></a
    									><a
    										class="tutnav-card"
    										data-name="json"
    										data-category="javascript"
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M7 4a2 2 0 0 0-2 2v3a2 3 0 0 1-2 3 2 3 0 0 1 2 3v3a2 2 0 0 0 2 2"></path>
    												<path
    													d="M17 4a2 2 0 0 1 2 2v3a2 3 0 0 0 2 3 2 3 0 0 0-2 3v3a2 2 0 0 1-2 2"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">JSON</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">RWD</h4>
    										<p class="tutnav-card-desc">Responsive web design</p></a
    									><a
    										class="tutnav-card"
    										data-name="colors"
    										data-category="html_and_css"
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<circle
    													...
    													r="2.5"
    													fill="#36A2EB"></circle>
    												<circle cx="8" cy="8" r="2.5" fill="#FFCE56"></circle>
    												<circle
    													cx="6.5"
    													cy="14"
    													r="2.5"
    										...
    										<h4 class="tutnav-card-title">Colors</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Icons</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<polyline
    													points="3.27 6.96 12 12.01 20.73 6.96"></polyline>
    												<line x1="12" y1="22.08" x2="12" y2="12"></line>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">SVG</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Canvas</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Graphics</h4>
    										<p class="tutnav-card-desc">Web graphics tutorials</p></a
    									><a
    										class="tutnav-card"
    										data-name="ajax"
    										data-category="javascript"
    										...
    										<h4 class="tutnav-card-title">AJAX</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">AppML</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">W3.JS</h4>
    										<p class="tutnav-card-desc">
    											W3Schools JavaScript library
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="chatgpt35"
    										...
    										<h4 class="tutnav-card-title">ChatGPT-3.5</h4>
    										<p class="tutnav-card-desc">OpenAI language model</p></a
    									><a
    										class="tutnav-card"
    										data-name="chatgpt4"
    										data-category="data_analytics"
    										...
    										<h4 class="tutnav-card-title">ChatGPT-4</h4>
    										<p class="tutnav-card-desc">
    											Advanced OpenAI language model
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="google_bard"
    										data-category="data_analytics"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    										...
    										<h4 class="tutnav-card-title">Google Bard</h4>
    										<p class="tutnav-card-desc">Google AI assistant</p></a
    									><a
    										class="tutnav-card"
    										data-name="machine_learning"
    										data-category="data_analytics"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    										...
    										<h4 class="tutnav-card-title">Machine Learning</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Matplotlib</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Statistics</h4>
    										<p class="tutnav-card-desc">
    											Mathematical statistics basics
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="google_sheets"
    										data-category="data_analytics"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												viewBox="0 0 24 24">
    												<path
    													d="M11.318 12.545H7.91v-1.909h3.41v1.91zm4.772 0h-3.41v-1.909h3.41v1.91zm-4.772 3.273H7.91V13.91h3.41v1.91zm4.772 0h-3.41V13.91h3.41v1.91zM14.182 0v6.545h6.545zm4.363 24H5.455A2.182 2.182 0 013.273 21.818V2.182A2.182 2.182 0 015.455 0h10.09l5.182 5.182v16.636A2.182 2.182 0 0118.545 24z"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Google Sheets</h4>
    										<p class="tutnav-card-desc">Online spreadsheet tool</p></a
    									><a
    										class="tutnav-card"
    										data-name="charsets"
    										data-category="html_and_css"
    										...
    										<h4 class="tutnav-card-title">UTF-8 / Emojis</h4>
    										<p class="tutnav-card-desc">
    											Character sets and encoding
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="raspberry_pi"
    										data-category="backend"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<circle cx="6" cy="8" r="1" fill="#C51A4A"></circle>
    												<circle cx="6" cy="12" r="1" fill="#C51A4A"></circle>
    												<circle cx="6" cy="16" r="1" fill="#C51A4A"></circle>
    												<rect
    													x="9"
    													y="8"
    													width="6"
    										...
    										<h4 class="tutnav-card-title">Raspberry Pi</h4>
    										<p class="tutnav-card-desc">
    											Small computer for projects
    										</p></a
    									><a
    										class="tutnav-card"
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<path d="M12 8v6M8 10l4 2 4-2M10 18l2-4 2 4"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Accessibility</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Spaces</h4>
    										<p class="tutnav-card-desc">
    											Your own space to code and share
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="typingspeed"
    										data-category="web_building"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<rect
    													...
    													rx="2"></rect>
    												<path
    													d="M6 10h.01M10 10h.01M14 10h.01M18 10h.01M8 14h.01M12 14h.01M16 14h.01M6 14h.01M18 14h.01"></path>
    												<path d="M8 17h8"></path>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Typing Speed Test</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										><div class="tutnav-icon-wrap">
    											<svg
    												...
    												<circle cx="15" cy="11" r="1" fill="#E91E63"></circle>
    												<circle cx="18" cy="13" r="1" fill="#E91E63"></circle>
    											</svg>
    										</div>
    										<h4 class="tutnav-card-title">Code Game</h4>
    										<p class="tutnav-card-desc">
    									...
    									><a
    										...
    										<h4 class="tutnav-card-title">Code Editor</h4>
    										<p class="tutnav-card-desc">
    											Write and run code in your browser
    										</p></a
    									><a
    										class="tutnav-card"
    										data-name="webtemplates"
    										data-category="html_and_css"
    										href="javascript:void(0)"
    										><div class="tutnav-icon-wrap">
    											<svg
    										...
    										<h4 class="tutnav-card-title">Web Templates</h4>
    										<p class="tutnav-card-desc">Free website templates</p></a
    									><a
    										class="tutnav-card"
    										...
    										<h4 class="tutnav-card-title">Newsletter</h4>
    										<p class="tutnav-card-desc">
    											Stay updated with W3Schools
    										</p></a
    									>
    								</div>
    							</div>
    							<!-- DETAIL VIEW (shown when a card is clicked) -->
    							<div id="tutnav_detail_view" class="tutnav-detail-view">
    								<div class="tutnav-topics-scroll">
    									<button class="tutnav-back-btn" id="tutnav_back_btn">
    										← All Topics
    									</button>
    									<div class="tutnav-topic-header">
    										<div
    											class="tutnav-topic-header-icon"
    											id="tutnav_detail_icon"></div>
    										<h2
    											class="tutnav-topic-title"
    											id="tutnav_detail_title"></h2>
    									</div>
    									<div
    										class="tutnav-option-cards"
    										id="tutnav_detail_options"></div>
    								</div>
    							</div>
    						</div>
    					</div>
    				...
    				<nav
    					...
    					<div class="refnav-wrap">
    						...
    						<div id="references_list">
    							<div id="refnav_quick_actions">
    								<div class="certnav-ref-row">
    									<div class="certnav-ref-card certnav-ref-card-cert">
    										<div class="certnav-ref-card-text">
    											<h2 class="certnav-ref-card-title">
    												Become
    												<span class="certnav-ref-topic">W3Schools</span>
    											...
    											<p class="certnav-ref-access">
    												...
    												<a
    													...
    													onclick="
    														event.preventDefault();
    														TopNavBar.handleRedirect(
    															'TopNavBar.initDropdownNavs.references.heroPlan',
    															'https://order.w3schools.com/plans',
    														);
    													"
    													>Hero plan</a
    											...
    											<a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.references.defaultCert',
    														'https://campus.w3schools.com/collections/course-catalog',
    													);
    												"
    												>Get W3Schools Certified</a
    							...
    							<div class="refnav-topics-scroll">
    								<div class="refnav-grid">
    									<div class="refnav-card" data-name="html">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    												height="40"
    									...
    									<div class="refnav-card" data-name="css">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="javascript">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="sql">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="python">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="java">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="32"
    									...
    									<div class="refnav-card" data-name="c">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="colors">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="php">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="htmldom">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="mysql">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="w3css">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="bootstrap3">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="bootstrap4">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="nodejs">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="django">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="jquery">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="vue">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="angular">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="sass">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="xml">
    										<div class="refnav-icon-wrap">
    											<svg
    												stroke="currentColor"
    												fill="none"
    									...
    									<div class="refnav-card" data-name="json">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="asp">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="icons">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="svg">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="canvas">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="charsets">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="emojis">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    												...
    												viewBox="0 0 24 24">
    												<circle cx="12" cy="12" r="10"></circle>
    												<circle cx="9" cy="10" r="1.5" fill="#333"></circle>
    												<circle cx="15" cy="10" r="1.5" fill="#333"></circle>
    												<path
    									...
    									<div class="refnav-card" data-name="appml">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<div class="refnav-card" data-name="w3js">
    										<div class="refnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    				...
    				<nav
    					...
    					onclick="
    						if (event.target === this) {
    							if (window.exnavBackToList) exnavBackToList();
    					...
    					<div class="exnav-wrap">
    						...
    						<div id="exnav_main_heading" class="exnav-main-heading">
    							<h1 class="exnav-main-title">W3SCHOOLS EXERCISES</h1>
    							<p class="exnav-main-desc"></p>
    						</div>
    						<div id="exercises_list">
    							<div id="exnav_quick_actions">
    								<div class="exnav-quick-actions">
    									<div class="exnav-quick-grid">
    										<div class="exnav-quick-card-wrap">
    											<a
    												class="exnav-quick-card"
    												href="javascript:void(0)"
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.default.0',
    														'https://www.w3schools.com/exercises/index.php',
    													);
    												"
    												><div class="exnav-quick-card-icon">
    													<svg
    														xmlns="http://www.w3.org/2000/svg"
    														width="24"
    														height="24"
    														...
    														stroke-linecap="round"
    														stroke-linejoin="round"
    														class="lucide lucide-dumbbell chakra-icon css-1r75o6f"
    														focusable="false">
    												...
    												<div class="exnav-quick-card-text">
    													<p class="exnav-quick-card-title">Exercises</p>
    													<p class="exnav-quick-card-desc">
    														Practice with interactive exercises
    													</p>
    													<span class="exnav-quick-btn"
    														>Browse Exercises</span
    													>
    												</div></a
    											><a
    												class="exnav-quick-card-subtitle"
    												href="javascript:void(0)"
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.defaultSubtitle.0',
    														'https://www.w3schools.com/exercises/index.php',
    													);
    												"
    												>What is an Exercise?</a
    											>
    										</div>
    										<div class="exnav-quick-card-wrap">
    											<a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.default.1',
    											...
    											><a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.defaultSubtitle.1',
    														'https://www.w3schools.com/quiztest/default.asp',
    													);
    												"
    												>What is a Quiz?</a
    										...
    										<div class="exnav-quick-card-wrap">
    											<a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.default.2',
    														'https://www.w3schools.com/challenges/index.php',
    													);
    												"
    												><div class="exnav-quick-card-icon">
    													<svg
    														...
    														fill="none"
    														focusable="false"
    														class="chakra-icon chakra-icon css-171ity7">
    														<path
    															fill="none"
    															stroke="currentColor"
    															stroke-width="1.5"
    											...
    											><a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.defaultSubtitle.2',
    														'https://www.w3schools.com/challenges/index.php',
    													);
    												"
    												>What is a Challenge?</a
    											>
    										</div>
    										<div class="exnav-quick-card-wrap">
    											<a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.default.3',
    											...
    											><a
    												...
    												onclick="
    													event.preventDefault();
    													TopNavBar.handleRedirect(
    														'TopNavBar.initDropdownNavs.exercises.defaultSubtitle.3',
    														'https://www.w3schools.com/practice/index.php',
    													);
    												"
    												>What is a Practice Problem?</a
    											>
    										</div>
    									</div>
    								</div>
    								...
    								<div class="exnav-quick-social">
    									<a
    										...
    										<svg width="18" height="18" viewBox="0 0 48 48">
    											...
    											<path
    												fill="#1976D2"
    												d="M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 5.571l.003-.002 6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.65-.389-3.917z"></path>
    										</svg>
    									</a>
    									<a
    										href="https://profile.w3schools.com/signup"
    							...
    							<div class="exnav-header">
    								<h2 class="exnav-section-heading">Select a topic:</h2>
    							...
    							<div class="exnav-topics-scroll">
    								<div class="exnav-grid">
    									<!-- 1. HTML -->
    									<div class="exnav-card" data-name="html">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    												height="40"
    									...
    									<!-- 2. CSS -->
    									<div class="exnav-card" data-name="css">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 3. JAVASCRIPT -->
    									<div class="exnav-card" data-name="javascript">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 4. SQL -->
    									<div class="exnav-card" data-name="sql">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 5. PYTHON -->
    									<div class="exnav-card" data-name="python">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    												...
    												<path
    													d="M15.885 2.1c-7.1 0-6.651 3.07-6.651 3.07v3.19h6.752v1H6.545S2 8.8 2 16.005s4.013 6.912 4.013 6.912H8.33v-3.361s-.13-4.013 3.9-4.013h6.762s3.772.06 3.772-3.652V5.8s.572-3.712-6.842-3.712zm-3.732 2.137a1.214 1.214 0 1 1 0 2.428 1.214 1.214 0 0 1 0-2.428z"
    													fill="url(#ex-py-b)"></path>
    												<path
    													d="M16.085 29.91c7.1 0 6.651-3.08 6.651-3.08v-3.18h-6.751v-1h9.47S30 23.158 30 15.995s-4.013-6.912-4.013-6.912H23.64v3.361s.13 4.013-3.9 4.013h-6.765S9.2 16.4 9.2 20.112v6.091s-.572 3.712 6.842 3.712zm3.732-2.147a1.214 1.214 0 1 1 0-2.428 1.214 1.214 0 0 1 0 2.428z"
    													fill="url(#ex-py-y)"></path>
    											</svg>
    										</div>
    									...
    									<!-- 6. JAVA -->
    									<div class="exnav-card" data-name="java">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="32"
    									...
    									<!-- 7. C -->
    									<div class="exnav-card" data-name="c">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 10. PHP -->
    									<div class="exnav-card" data-name="php">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 11. REACT -->
    									<div class="exnav-card" data-name="react">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 12. MYSQL -->
    									<div class="exnav-card" data-name="mysql">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 13. EXCEL -->
    									<div class="exnav-card" data-name="excel">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 14. DSA -->
    									<div class="exnav-card" data-name="dsa">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 15. BOOTSTRAP 3 -->
    									<div class="exnav-card" data-name="bootstrap3">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 16. BOOTSTRAP 4 -->
    									<div class="exnav-card" data-name="bootstrap4">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 17. BOOTSTRAP 5 -->
    									<div class="exnav-card" data-name="bootstrap5">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 18. NODEJS -->
    									<div class="exnav-card" data-name="nodejs">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 19. TYPESCRIPT -->
    									<div class="exnav-card" data-name="typescript">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 20. DJANGO -->
    									<div class="exnav-card" data-name="django">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 21. POSTGRESQL -->
    									<div class="exnav-card" data-name="postgresql">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 22. JQUERY -->
    									<div class="exnav-card" data-name="jquery">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 23. NUMPY -->
    									<div class="exnav-card" data-name="numpy">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 24. PANDAS -->
    									<div class="exnav-card" data-name="pandas">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 25. ANGULAR -->
    									<div class="exnav-card" data-name="angular">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 26. GIT -->
    									<div class="exnav-card" data-name="git">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 29. MONGODB -->
    									<div class="exnav-card" data-name="mongodb">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 27. R -->
    									<div class="exnav-card" data-name="r">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 33. GO -->
    									<div class="exnav-card" data-name="go">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 34. KOTLIN -->
    									<div class="exnav-card" data-name="kotlin">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 34a. SWIFT -->
    									<div class="exnav-card" data-name="swift">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 30. VUE -->
    									<div class="exnav-card" data-name="vue">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 31. SCIPY -->
    									<div class="exnav-card" data-name="scipy">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="40"
    									...
    									<!-- 32. BASH -->
    									<div class="exnav-card" data-name="bash">
    										<div class="exnav-icon-wrap">
    											<svg
    												xmlns="http://www.w3.org/2000/svg"
    												width="38"
    						...
    						<div id="exnav_detail" class="exnav-detail">
    							<div class="exnav-detail-header">
    								<div class="exnav-detail-icon" id="exnav_detail_icon"></div>
    								<div class="exnav-detail-header-text">
    									<h2 class="exnav-detail-title" id="exnav_detail_title"></h2>
    									<p class="exnav-detail-subtitle" id="exnav_detail_subtitle">
    										Choose an activity
    									</p>
    								</div>
    								<button class="exnav-detail-back" onclick="exnavBackToList()">
    									← Back to topics
    								</button>
    							</div>
    							<div class="exnav-detail-grid" id="exnav_detail_grid"></div>
    				...
    				<nav
    					...
    					<div class="certnav-wrap">
    						...
    						<div id="certified_list">
    							<div id="certnav_quick_actions">
    								<h2
    									style="
    										...
    										color: #04aa6d;
    										font-family:
    											&quot;Source Sans Pro Topnav&quot;, sans-serif;
    									">
    									BEST VALUE W3SCHOOLS CERTIFICATES:
    								</h2>
    								<div class="cert-prog-grid">
    									<a
    										class="cert-prog-card"
    										href="javascript:void(0)"
    										onclick="
    											event.preventDefault();
    											TopNavBar.handleRedirect(
    												'TopNavBar.initDropdownNavs.certified.program.0',
    												'https://campus.w3schools.com/collections/course-catalog/products/w3schools-full-access-course',
    											);
    										"
    										...
    										<div class="cert-prog-card-label">Full Access</div>
    										<div class="cert-prog-card-title">Full Access Course</div>
    										<div class="cert-prog-card-desc">
    											Complete access to all W3Schools courses and
    											certifications.
    										</div>
    										<span class="cert-prog-card-btn">Get Full Access</span></a
    									><a
    										class="cert-prog-card"
    										href="javascript:void(0)"
    										onclick="
    											event.preventDefault();
    											TopNavBar.handleRedirect(
    												'TopNavBar.initDropdownNavs.certified.program.1',
    													...
    													<svg
    														...
    														<defs>
    															...
    															<linearGradient
    																...
    																<stop
    																	offset="100%"
    																	stop-color="#FFC331"></stop>
    															</linearGradient>
    														</defs>
    														<path
    															d="M15.885 2.1c-7.1 0-6.651 3.07-6.651 3.07v3.19h6.752v1H6.545S2 8.8 2 16.005s4.013 6.912 4.013 6.912H8.33v-3.361s-.13-4.013 3.9-4.013h6.762s3.772.06 3.772-3.652V5.8s.572-3.712-6.842-3.712zm-3.732 2.137a1.214 1.214 0 1 1 0 2.428 1.214 1.214 0 0 1 0-2.428z"
    															fill="url(#prog-py-b)"></path>
    														<path
    															d="M16.085 29.91c7.1 0 6.651-3.08 6.651-3.08v-3.18h-6.751v-1h9.47S30 23.158 30 15.995s-4.013-6.912-4.013-6.912H23.64v3.361s.13 4.013-3.9 4.013h-6.765S9.2 16.4 9.2 20.112v6.091s-.572 3.712 6.842 3.712zm3.732-2.147a1.214 1.214 0 1 1 0-2.428 1.214 1.214 0 0 1 0 2.428z"
    															fill="url(#prog-py-y)"></path>
    													</svg>
    												</div>
    												<div
    													style="
    										...
    										<div class="cert-prog-card-label">Data Analytics</div>
    										<div class="cert-prog-card-title">
    											Data Analytics Program
    										</div>
    										<div class="cert-prog-card-desc">
    											Master data analysis, visualization, and machine
    											learning.
    										</div>
    										<span class="cert-prog-card-btn">Get Certified</span></a
    									><a
    										class="cert-prog-card"
    										href="javascript:void(0)"
    										onclick="
    											event.preventDefault();
    											TopNavBar.handleRedirect(
    												'TopNavBar.initDropdownNavs.certified.program.2',
    												'https://campus.w3schools.com/collections/course-catalog/products/frontend-course',
    											);
    										"
    										style="position: relative; overflow: hidden"
    										><div class="cert-prog-card-icon">
    											<div
    												...
    												<div
    													style="position: absolute; top: -1px; left: -30px">
    													<svg
    														xmlns="http://www.w3.org/2000/svg"
    														width="40"
    														height="40"
    										...
    										<div class="cert-prog-card-label">Front End</div>
    										<div class="cert-prog-card-title">Front End Course</div>
    										<div class="cert-prog-card-desc">
    											Build modern, responsive websites with HTML, CSS and
    											JavaScript.
    										</div>
    										<span class="cert-prog-card-btn">Get Certified</span></a
    									><a
    										...
    										onclick="
    											event.preventDefault();
    											TopNavBar.handleRedirect(
    												'TopNavBar.initDropdownNavs.certified.program.3',
    												'https://campus.w3schools.com/collections/course-catalog/products/learn-modern-web-development',
    											);
    										"
    										style="position: relative; overflow: hidden"
    										><div class="cert-prog-card-icon">
    										...
    										<div class="cert-prog-card-label">Web Development</div>
    										<div class="cert-prog-card-title">Web Dev Course</div>
    										<div class="cert-prog-card-desc">
    											Full-stack web development from fundamentals to
    											deployment.
    										</div>
    										<span class="cert-prog-card-btn">Get Certified</span></a
    									>
    							...
    							<div id="certnav_header" class="certnav-header">
    								<h2
    									id="certnav_heading"
    							...
    							<div class="certnav-topics-scroll">
    								<div id="certnav_grid" class="certnav-grid">
    									<a
    										class="certnav-card"
    										data-name="html"
    									...
    									<a
    										...
    										<div class="certnav-icon-wrap">
    											<svg
    												...
    												<path
    													d="M15.885 2.1c-7.1 0-6.651 3.07-6.651 3.07v3.19h6.752v1H6.545S2 8.8 2 16.005s4.013 6.912 4.013 6.912H8.33v-3.361s-.13-4.013 3.9-4.013h6.762s3.772.06 3.772-3.652V5.8s.572-3.712-6.842-3.712zm-3.732 2.137a1.214 1.214 0 1 1 0 2.428 1.214 1.214 0 0 1 0-2.428z"
    													fill="url(#cert-py-b)"></path>
    												<path
    													d="M16.085 29.91c7.1 0 6.651-3.08 6.651-3.08v-3.18h-6.751v-1h9.47S30 23.158 30 15.995s-4.013-6.912-4.013-6.912H23.64v3.361s.13 4.013-3.9 4.013h-6.765S9.2 16.4 9.2 20.112v6.091s-.572 3.712 6.842 3.712zm3.732-2.147a1.214 1.214 0 1 1 0-2.428 1.214 1.214 0 0 1 0 2.428z"
    													fill="url(#cert-py-y)"></path>
    											</svg>
    										</div>
    								...
    								<div
    									...
    									<label class="tnb-toggle-darkmode-switch w3-tooltip">
    										...
    										<span
    											class="tnb-toggle-darkmode-slider fa"
    											style="user-select: none">
    											<span style="position: absolute; left: -1px; top: -2px"
    												></span
    											>
    										</span>
    									</label>
    							...
    							<div class="serviceboxes">
    								<div class="servicebox">
    									<a
    										...
    										<div
    											...
    											<p>
    												Enjoy our free tutorials like millions of other
    												internet users since 1999
    											</p>
    										</div>
    									</a>
    								</div>
    								<div class="servicebox">
    									<a
    										...
    										<div
    											...
    											<h4>References</h4>
    											<p>
    												Explore our selection of references covering all
    								...
    								<div class="servicebox">
    									<a
    										...
    										<div
    											class="w3-padding services w3-round services-color-3">
    								...
    								<div class="servicebox">
    									<a
    										href="https://profile.w3schools.com/sign-up?redirect_url=https%3A%2F%2Fwww.w3schools.com%2F"
    								...
    								<div class="servicebox tnb-paid-service">
    									<a
    										...
    										<div
    											...
    											<h4>Upgrade</h4>
    											<p>
    												Become a PLUS user and unlock powerful features
    												(ad-free, hosting, support,..)
    											</p>
    											<svg
    												style="position: absolute; top: 15px; right: 25px"
    												width="15"
    								...
    								<div class="servicebox">
    									<a
    										...
    										<div
    											...
    											<p>
    												Not sure where you want to start? Follow our guided
    												path
    											</p>
    										</div>
    									</a>
    								...
    								<div class="servicebox">
    									<a
    										...
    										<div
    											...
    											<p>
    												With our online code editor, you can edit code and
    								...
    								<div class="servicebox tnb-paid-service">
    									<a
    										...
    										<div
    											...
    											<h4>Bootcamps</h4>
    											<p>
    												Learn from passionate instructors through live online
    												sessions
    											</p>
    											<svg
    												style="position: absolute; top: 15px; right: 25px"
    								...
    								<div class="servicebox">
    									<a
    										...
    										<div
    											...
    											<h4>Templates</h4>
    											<p>
    												We have created a bunch of responsive website
...
<h4>Color Picker</h4>
<p>
Use our color picker to find different RGB, HEX and
HSL colors.
<img
...
<h4>Newsletter</h4>
<p>
Join our newsletter and get access to exclusive
content every month
</p>
</div>
</a>
...
<p>
Check out our refererence page with all the emojis
supported in HTML
<span
														class="w3-hide-medium"
														alt="Smiley"
...
W3Schools Coding Game! Help the lynx collect pine
cones
<img
														class="w3-hide-medium"
...
<p>
Contact us about W3Schools Academy for your
organization
</p>
</div>
</a>
...
<div
										class="tnb-social-network-btns w3-hide-small w3-hide-medium">
<a
											target="_blank"
											href="https://www.youtube.com/@w3schools"
											title="W3Schools on YouTube"
...
<span>×</span>
    	...
    	<noscript
    		><iframe
    			src="https://www.googletagmanager.com/ns.html?id=GTM-KTCFC3S"
    			height="0"
    			width="0"
    	...
    	<style>
    		...
    		#btn_container_subtopnav {
    			...
    			top: 56px;
    			font-size: 0;
    			border-left: 10px solid rgba(40, 42, 53, 0.5);
    		}
    	...
    	<div class="topnavcontainer">
    		<div
    			id="subtopnav"
    			onmousedown="startscrolling_subtopnav(event)"
    			onmousemove="scrolling_subtopnav(event)"
    			onmouseup="endscrolling_subtopnav(event)"
    			...
    			<div id="menubtn_container">
    				<span>
    					<a
    						...
    						style="line-height: 1.1; padding-top: 3px !important"
    						onclick="open_menu()"
    						title="Menu"></a>
    				</span>
    			</div>
    			<a
    				...
    				class="ga-nav subtopnav_firstitem"
    				title="HTML Tutorial"
    				>HTML</a
    			>
    			<a href="/css/default.asp" class="ga-nav" title="CSS Tutorial">CSS</a>
    			<a href="/js/default.asp" class="ga-nav" title="JavaScript Tutorial"
    				>JAVASCRIPT</a
    			>
    			<a href="/sql/default.asp" class="ga-nav" title="SQL Tutorial">SQL</a>
    			<a href="/python/default.asp" class="ga-nav" title="Python Tutorial"
    				>PYTHON</a
    			>
    			<a href="/java/default.asp" class="ga-nav" title="Java Tutorial"
    				>JAVA</a
    			>
    			<a href="/php/default.asp" class="ga-nav" title="PHP Tutorial">PHP</a>
    			<a href="/w3css/default.asp" class="ga-nav" title="W3.CSS Tutorial"
    				>W3.CSS</a
    			>
    			...
    			<a
    				...
    				>BOOTSTRAP</a
    			>
    			<a href="/react/default.asp" class="ga-nav" title="React Tutorial"
    				>REACT</a
    			>
    			<a href="/mysql/default.asp" class="ga-nav" title="MySQL Tutorial"
    				>MYSQL</a
    			>
    			<a href="/jquery/default.asp" class="ga-nav" title="JQuery Tutorial"
    				>JQUERY</a
    			>
    			<a href="/excel/index.php" class="ga-nav" title="Excel Tutorial"
    				>EXCEL</a
    			>
    			<a href="/xml/default.asp" class="ga-nav" title="XML Tutorial">XML</a>
    			<a href="/django/index.php" class="ga-nav" title="Django Tutorial"
    				>DJANGO</a
    			>
    			<a
    			...
    			<a
    				...
    				>PANDAS</a
    			>
    			<a href="/nodejs/default.asp" class="ga-nav" title="Node.js Tutorial"
    				>NODEJS</a
    			>
    			...
    			<a
    				...
    				>TYPESCRIPT</a
    			>
    			<a href="/angular/default.asp" class="ga-nav" title="Angular Tutorial"
    				>ANGULAR</a
    			>
    			<a
    			...
    			<a
    				...
    				>POSTGRESQL</a
    			>
    			<a href="/mongodb/index.php" class="ga-nav" title="MongoDB Tutorial"
    				>MONGODB</a
    			>
    			...
    			<a href="/kotlin/index.php" class="ga-nav" title="Kotlin Tutorial"
    				>KOTLIN</a
    			>
    			<a href="/swift/default.asp" class="ga-nav" title="Swift Tutorial"
    				>SWIFT</a
    			>
    			<a href="/sass/default.asp" class="ga-nav" title="Sass Tutorial"
    				>SASS</a
    			>
    			<a href="/vue/index.php" class="ga-nav" title="Vue.js Tutorial">VUE</a>
    			<a href="/gen_ai/index.php" class="ga-nav" title="Gen A.I. Tutorial"
    				>GEN AI</a
    			>
    			<a href="/python/scipy/index.php" class="ga-nav" title="SciPy Tutorial"
    				>SCIPY</a
    			>
    			...
    			<a href="/tools/index.php" class="ga-nav" title="Web Developer Tools"
    				>TOOLS</a
    			>
    			<a
    				href="javascript:void(0)"
    				style="width: 50px; visibility: hidden"></a>
    		</div>
    	</div>
    	<!--
...
ny:-->
				<div class="w3-main ws-light-grey" id="belowtopnav">
					<!--original:
...
ny:-->
						<div class="w3-col l12 m12 w3-white" id="main">
							<div
								class="ws-black w3-center herosection"
								style="position: relative">
								<!-- Full-width hero for the homepage. Logged in: greeting + continue + badge grid.
     Signed out / frozen: free pitch + aspiration carousel with Sign in / Reactivate.
     Self-contained (accessToken cookie). -->
								<div id="dashboard-hero" class="dlh-host">
									<div class="dlh dlh-anon">
										<div class="dlh-left">
											<h1 class="dlh-title">Learn to Code</h1>
											<p class="dlh-free">
												Free tutorials, examples and references.<br /><b
													>No sign-up needed, just start learning.</b
												>
											</p>
											<p class="dlh-support">
											...
											<div class="dlh-sub">
												Already a member?
												<a
													class="ga-featured ga-frontpage-signin-link"
													href="https://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fwww.w3schools.com%2F"
													onclick="event.preventDefault();event.stopPropagation();if(typeof TopNavBar!=='undefined'&amp;&amp;typeof TopNavBar.showLoginDropdown==='function'){TopNavBar.showLoginDropdown();}else{window.open(this.href,'_blank');}"
													>Sign in</a
												>
											</div>
										</div>
										<div class="dlh-right">
											<div class="dlw-caro">
												<div class="dlw-caro-lock" aria-hidden="true">
													<svg viewBox="0 0 24 24" fill="#04AA6D">
														<path
															d="M12 1a5 5 0 0 0-5 5v3H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2h-1V6a5 5 0 0 0-5-5zm3 8H9V6a3 3 0 0 1 6 0v3z"></path>
													</svg>
												</div>
												<div
													class="dlw-caro-track"
													style="transform: translateX(-400%)">
													<div class="dlw-slide dlw-combo">
														<div class="dlw-combo-head">
															<span class="dlw-vis-bolt"
																><svg viewBox="0 0 24 24" fill="#FFD23F">
																	<path
																		d="M13 2L4.5 13.5H11l-1 8.5L19.5 10H12.5z"></path></svg></span
															><span class="dlw-vis-num dlw-vis-green"
																>12,560</span
															>
														</div>
														<div class="dlw-slide-cap">
															<b>Keep learning. Keep leveling up.</b
															><span
																>Track your progress and achieve more.</span
															>
														</div>
														<div class="dlw-combo-stats">
															<div class="dlw-combo-stat">
																<span class="dlw-combo-label">XP this week</span
																><span>850</span>
															</div>
															<div class="dlw-combo-div"></div>
															<div class="dlw-combo-stat">
																<span class="dlw-combo-flame"
																	><svg
																		width="40"
																		height="45"
																		viewBox="0 0 43 48"
																		...
																		<path
																			fill-rule="evenodd"
																			clip-rule="evenodd"
																			d="M0 28.3147C0 39.1866 8.62988 48 20.648 48C32.6662 48 42.4089 39.1866 42.4089 28.3147C42.4089 16.4391 34.0874 7.3021 26.6681 0.526583C26.3281 0.216026 25.8182 0.179203 25.4495 0.455052C23.0134 2.27727 21.0501 4.77236 19.5597 7.94034C18.0644 11.1186 17.0726 14.8936 16.5843 19.2653C16.5189 19.8511 15.971 20.2697 15.4048 20.1058C13.7124 19.6161 12.2029 18.7388 10.8762 17.4737C9.5416 16.2011 8.22419 14.4474 6.92394 12.2125C6.55348 11.5758 5.64722 11.513 5.23907 12.1263C1.82501 17.2561 0 22.9643 0 28.3147Z"
																			fill="#FF9600"></path>
																		<path
																			d="M33.894 28.9292C33.2264 33.1276 29.8718 36.4211 25.5957 37.0766"
																			stroke="#FF5D39"
																			stroke-width="4"
																			stroke-linecap="round"
																			stroke-linejoin="round"></path></svg></span
																><span>7</span
																><span class="dlw-combo-label">Day streak</span>
															</div>
														</div>
													</div>
													<div class="dlw-slide">
														<div class="dlw-slide-vis dlw-vis-build">
															<picture
																><source
																	srcset="/images/img_spaces_preview.webp"
																	type="image/webp" />
																<img
																	class="dlw-vis-spaces-img"
																	src="/images/img_spaces_preview.png"
																	alt=""
																	loading="lazy"
															/></picture>
														</div>
														<div class="dlw-slide-cap">
															<b>Build &amp; host sites</b
															><span>Your own Spaces, live on the web</span>
														</div>
													</div>
													<div class="dlw-slide">
														<div class="dlw-slide-vis dlw-vis-practice">
															<picture
																><source
																	srcset="/images/img_mockup.webp"
																	type="image/webp" />
																<img
																	class="dlw-vis-practice-img"
														...
														<div class="dlw-slide-cap">
															<b>Weekly practice</b
															><span>Fresh problems &amp; bonus XP</span>
														</div>
													</div>
													<div class="dlw-slide">
														<a
															class="dlw-vis-link ga-featured ga-frontpage-league-info"
															href="/league/"
															><div class="dlw-slide-vis dlw-vis-league">
																<img
																	src="https://pathfinder.w3schools.com/images/leagues/wood.svg"
																	alt="" /><span class="dlw-vis-arrow">›</span
																><img
																	src="https://pathfinder.w3schools.com/images/leagues/gold.svg"
																	alt="" /><span class="dlw-vis-arrow">›</span
																><img
																	class="dlw-vis-hi"
																	src="https://pathfinder.w3schools.com/images/leagues/diamond.svg"
																	alt="" /></div
														></a>
														<div class="dlw-slide-cap">
															<b
																><a
																	class="dlw-cap-link ga-featured ga-frontpage-league-info"
																	href="/league/"
																	>Climb the leagues</a
																></b
															><span>From Wood to Master Coder</span>
														</div>
													</div>
													<div class="dlw-slide">
														<div class="dlw-slide-vis dlw-vis-noads">
															<span class="dlw-vis-noads-ico"
																><svg
																	viewBox="0 0 24 24"
																	fill="none"
																	stroke="#7ee0b8"
														...
														<div class="dlw-slide-cap">
															<b>Ad-free learning</b
															><span>Focus with zero distractions</span>
														</div>
													</div>
													<div class="dlw-slide">
														<div class="dlw-slide-vis dlw-vis-avatar">
															<img
																class="dlw-vis-av"
																src="/images/lynx.svg"
																alt="" /><span class="dlw-vis-chip"
																><img
																	src="/lib/account/img/avatar_shirt.png"
																	alt=""
																	loading="lazy" /></span
															><span class="dlw-vis-chip"
																><img
																	src="/lib/account/img/avatar_shorts.png"
																	alt=""
																	loading="lazy"
															/></span>
														</div>
														<div class="dlw-slide-cap">
															<b>Customize your avatar</b
															><span>Unlock gear, moods &amp; rare skins</span>
														</div>
													</div>
												</div>
												<a
													class="dlw-caro-cta ga-featured ga-frontpage-signin"
													href="https://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fwww.w3schools.com%2F"
													onclick="event.preventDefault();event.stopPropagation();if(typeof TopNavBar!=='undefined'&amp;&amp;typeof TopNavBar.showLoginDropdown==='function'){TopNavBar.showLoginDropdown();}else{window.open(this.href,'_blank');}"
													>Sign in</a
												>
												<div class="dlw-caro-dots">
													<button
														class="dlw-dot ga-featured ga-frontpage-carousel-dot"
													...
													><button
														class="dlw-dot ga-featured ga-frontpage-carousel-dot active"
								...
								<script src="/lib/account/dashboard-lite.js?updated=20260611"></script>
								<script>
									DashboardLite.renderHero("dashboard-hero");
								</script>
							</div>
    						...
    						<svg
    							...
    							<path
    								id="wavepath"
    								d="M0,0  L100, 0C35,150 35,0 0,100z"
    								fill="#282A35"></path>
    						</svg>

    						<div
    							class="w3-row w3-padding-32 ws-light-green"
    							...
    							<div class="w3-content">
    								<div class="w3-col l6 w3-center" style="padding: 3%">
    									...
    									<a
    										href="/html/default.asp"
    										class="w3-button ga-fp tut-button"
    									...
    									<a
    										...
    										class="w3-button ga-fp w3-block ref-button black-color"
    										>HTML Reference</a
    									><br />
    									<a
    										href="https://campus.w3schools.com/collections/certifications/products/html-certificate"
    										target="_blank"
    										class="w3-button ga-fp w3-block ws-pink ref-button ws-pink-hover"
    										title="Add HTML Certification"
    										>Get Certified</a
    									><br />
    								</div>
    								<div class="w3-col l6" style="padding: 3%">
    									<div
    										class="w3-hide-small grey-color w3-card-2 w3-round"
    										style="padding: 16px">
    										<h3>HTML Example:</h3>
    										<div
    											class="w3-code htmlHigh notranslate green-border"
    											style="height: 300px">
    											<span class="doctypecolor" style="color: slategray"
    												>&lt;!DOCTYPE html&gt;</span
    											><br />
    											<span class="tagnamecolor" style="color: #905"
    												><span class="tagcolor" style="color: #999">&lt;</span
    												>html<span class="tagcolor" style="color: #999"
    													>&gt;</span
    												></span
    											><br /><span class="tagnamecolor" style="color: #905"
    												><span class="tagcolor" style="color: #999">&lt;</span
    												>head<span class="tagcolor" style="color: #999"
    													>&gt;</span
    												></span
    											><br />
    											<span class="tagnamecolor" style="color: #905"
    												><span class="tagcolor" style="color: #999">&lt;</span
    												>title<span class="tagcolor" style="color: #999"
    													>&gt;</span
    												></span
    											>HTML Tutorial<span
    												class="tagnamecolor"
    											...
    											<span class="tagnamecolor" style="color: #905"
    												><span class="tagcolor" style="color: #999">&lt;</span
    												>body<span class="tagcolor" style="color: #999"
    													>&gt;</span
    												></span
    											><br /><br />
    											<span class="tagnamecolor" style="color: #905"
    												><span class="tagcolor" style="color: #999">&lt;</span
    												>h1<span class="tagcolor" style="color: #999"
    													>&gt;</span
    												></span
    											...
    											<span class="tagnamecolor" style="color: #905"
    												><span class="tagcolor" style="color: #999">&lt;</span
    												>p<span class="tagcolor" style="color: #999"
    													>&gt;</span
    												></span
    										...
    										<a
    											href="/html/tryit.asp?filename=tryhtml_default_default"
    											target="_blank"
    											class="w3-button ga-fp tryit-button"
    											>Try it Yourself</a
    										>
    									</div>
    								</div>
    							...
    							<div class="w3-content">
    								<div class="w3-col l6 w3-center" style="padding: 3%">
    									...
    									<a
    										...
    										class="w3-button ga-fp w3-block tut-button"
    										>Learn CSS</a
    									><br />
    									<a
    										href="/cssref/index.php"
    										class="w3-button ga-fp w3-block ref-button black-color"
    										>CSS Reference</a
    									><br />
    									<a
    								...
    								<div class="w3-col l6" style="padding: 3%">
    									<div
    										...
    										<div class="w3-code cssHigh notranslate green-border">
    											<span class="cssselectorcolor" style="color: #905">
    												body
    												<span class="cssdelimitercolor" style="color: #999"
    													>{</span
    												><span class="csspropertycolor" style="color: #d73a49"
    													><br />
    										...
    										<a
    											href="/css/tryit.asp?filename=trycss_default"
    											target="_blank"
    											class="w3-button ga-fp tryit-button"
    											>Try it Yourself</a
    										>
    							...
    							<div class="w3-content">
    								<div class="w3-col l6 w3-center" style="padding: 3%">
    									...
    									<a
    										...
    										class="w3-button ga-fp w3-block ref-button"
    									...
    									<a
    										...
    										target="_blank"
    										class="w3-button ga-fp w3-block ws-pink ref-button ws-pink-hover"
    										title="Add JavaScript Certification"
    										>Get Certified</a
    									><br />
    								</div>
    								<div class="w3-col l6" style="padding: 3%">
    									<div
    										...
    										<div class="w3-code notranslate green-border">
    											<div class="htmlHigh">
    												<span class="tagnamecolor" style="color: #905"
    													><span class="tagcolor" style="color: #999"
    														>&lt;</span
    													>button<span
    												...
    												>Click Me!<span
    													...
    													><span class="tagcolor" style="color: #999"
    														>&lt;</span
    													>/button<span class="tagcolor" style="color: #999"
    														>&gt;</span
    													></span
    												><br /><br />
    												<span class="tagnamecolor" style="color: #905"
    													><span class="tagcolor" style="color: #999"
    														>&lt;</span
    													>script<span class="tagcolor" style="color: #999"
    														>&gt;</span
    													></span
    												><span class="jscolor" style="color: black"
    													><br />
    													<span class="jskeywordcolor" style="color: #005cc5"
    														>function</span
    													>
    													myFunction() {<br /><span
    														class="jsnumbercolor"
    													...
    													x = document.<span
    														...
    														style="color: black"
    														>getElementById</span
    													>(<span class="jsstringcolor" style="color: green"
    														>"demo"</span
    													>);<br /><span
    														class="jsnumbercolor"
    														style="color: #905">
    													...
    													>&nbsp; x.<span
    														...
    														style="color: black"
    														>style</span
    													>.<span class="jspropertycolor" style="color: black"
    														>fontSize</span
    													>
    													=
    													<span class="jsstringcolor" style="color: green"
    										...
    										<a
    											href="/js/tryit.asp?filename=tryjs_default"
    											target="_blank"
    											class="w3-button ga-fp tryit-button"
    											>Try it Yourself</a
    										>
    							...
    							<div class="w3-content">
    								<div class="w3-col l6 w3-center" style="padding: 3%">
    									...
    									<a
    										...
    										class="w3-button ga-fp ref-button black-color"
    										>Python Reference</a
    									><br />
    									<a
    								...
    								<div class="w3-col l6" style="padding: 3%">
    									<div
    										...
    										<div
    											class="w3-code jsHigh notranslate green-border"
    											style="height: 210px">
    											<span class="jscolor" style="color: black"
    										...
    										<a
    											href="/python/trypython.asp?filename=demo_indentation"
    											target="_blank"
    											class="w3-button ga-fp tryit-button"
    											>Try it Yourself</a
    										>
    									...
    									<div
    										...
    										<div
    											...
    											<span class="sqlcolor" style="color: black"
    												...
    												<span class="sqlkeywordcolor" style="color: #005cc5"
    													>SELECT</span
    												>
    												*
    												<span class="sqlkeywordcolor" style="color: #005cc5"
    							...
    							<div style="max-width: 1400px; margin: auto">
    								<div class="w3-col l6 w3-center" style="padding: 2% 3%">
    									<div
    										...
    										<a
    											...
    											class="w3-button ga-fp tut-button black-color w3-margin-bottom"
    											>Learn PHP</a
    										>
    									</div>
    								</div>
    								...
    								<div class="w3-col l6 w3-center" style="padding: 2% 3%">
    									<div
    										...
    										<div style="height: 70px">
    											<h5>
    												A CSS framework for faster and better responsive web
    												pages
    											</h5>
    										</div>
    										<a
    						...
    						<div
    							class="w3-row ws-black tutbuttons"
    							style="padding-bottom: 64px">
    							<div style="max-width: 1400px; margin: auto">
    								<div
    									class="w3-col l6 s12 w3-center"
    									style="padding: 2% 3%; height: auto">
    									<a href="/c/index.php" title="C Tutorial" class="ga-fp">
    										<div
    											class="w3-card-2 w3-round ws-pink"
    								...
    								<div
    									...
    									<a href="/cs/index.php" title="C# Tutorial" class="ga-fp">
    										<div
    											class="w3-card-2 w3-round ws-yellow"
    											style="padding: 36px 24px">
    											<h2 style="font-size: 30px; font-weight: 500">C#</h2>
    										</div>
    									</a>
    								...
    								<div
    									class="w3-col l3 m6 s12 w3-center"
    									style="padding: 2% 3%">
    									<a href="/r/default.asp" title="R Tutorial" class="ga-fp">
    										<div
    											class="w3-card-2 w3-round ws-light-pink"
    											style="padding: 24px">
    								...
    								<div
    									...
    									<a
    										...
    										class="ga-fp">
    										<div
    											class="w3-card-2 w3-round ws-light-green"
    								...
    								<div
    									...
    									<a
    										...
    										class="ga-fp">
    										<div
    											class="w3-card-2 w3-round ws-turquoise"
    											style="padding: 24px">
    											<h2 style="font-size: 30px; font-weight: 500">
    												Node.js
    											</h2>
    ...
    -->
    								...
    								<div
    									...
    									<a
    										...
    										<div
    											...
    											style="padding: 24px 0">
    											<h2 style="font-size: 30px; font-weight: 500">
    												Cyber<span class="ws-hide-special"> Security</span>
    											</h2>
    										</div>
    									</a>
    								</div>
    								...
    								<div
    									...
    									<a href="/dsa/index.php" title="DSA Tutorial" class="ga-fp">
    										<div
    											...
    											style="padding: 24px 0">
    											<h2 style="font-size: 30px; font-weight: 500">
    												DSA - D<span style="font-size: 80%">ata </span>S<span
    													style="font-size: 80%"
    													>tructures and </span
    												>A<span style="font-size: 80%">lgorithms</span>
    											</h2>
    										</div>
    									</a>
    								</div>
    								...
    								<div
    									...
    									<a
    										...
    										<div
    											class="w3-card-2 w3-round ws-yellow"
    											style="padding: 24px">
    											<h2 style="font-size: 30px; font-weight: 500">Swift</h2>
    										</div>
    									</a>
    								</div>
    						...
    						<div
    							...
    							<div class="w3-center w3-content w3-padding">
    								<h1 style="font-size: 65px; font-weight: 700">
    									Log in <span class="w3-hide-small">/ Sign Up</span>
    								</h1>
    								<h4 style="margin-top: 35px">
    									Create an account to track your progress, get your own
    									website,<br class="w3-hide-small" />and get access to more
    									features and learning materials:
    								</h4>
    								<picture>
    									<source
    										srcset="/images/image_landing.svg"
    										style="max-width: 100%" />
    									<img
    										src="/images/image_landing.svg"
    										alt="Log in"
    										style="max-width: 100%"
    										loading="lazy" />
    								</picture>
    						...
    						<div class="ws-black" style="padding: 70px 3px 85px 3px">
    							<div
    								...
    								<h4 style="margin-top: 25px" class="w3-center">
    									...
    									<div class="codeeditorbr-row">
    										<div class="codeeditorbr-column codeeditorbr-left">
    											<span
    												...
    												style="background: #ed594a"></span>
    											<span
    												class="codeeditorbr-dot"
    												style="background: #fdd800"></span>
    											<span
    												class="codeeditorbr-dot"
    												style="background: #5ac05a"></span>
    										</div>
    										...
    										<div class="codeeditorbr-column codeeditorbr-middle">
    											<input
    												type="text"
    												disabled=""
    												class="codeeditorbr-input"
    												value="www.w3schools.com/tryit/"
    												aria-label="w3schools.com/tryit" />
    										</div>
    									</div>
    									<div class="w3-bar" style="background-color: #f1f1f1">
    										<button
    											class="w3-bar-item w3-button ga-fp codeeditorbr-tablink ws-grey"
    											style="color: black"
    											onclick="openLangTab(event, 'Frontend')">
    											Frontend
    										</button>
    										<button
    											class="w3-bar-item w3-button ga-fp codeeditorbr-tablink"
    											style="color: black"
    											onclick="openLangTab(event, 'Backend')">
    											Backend
    										</button>
    									</div>
    ...
    -->
    								<a
    									href="/tryit/tryit.asp?filename=tryhtml_hello"
    									target="_blank"
    									class="ws-btn w3-mobile"
    									style="font-size: 18px; text-align: left"
    									>Try Frontend Editor (HTML/CSS/JS)</a
    								><br /><br />
    								<a
    									href="/tryit/trycompiler.asp?filename=demo_python"
    									target="_blank"
    									class="ws-btn w3-mobile ws-yellow hover-yellow"
    									style="font-size: 18px; text-align: left"
    									>Try Backend Editor (Python/PHP/Java/C..)</a
    								>
    							</div>
    						</div>
    						...
    						<div
    							...
    							<div
    								...
    								<h3 style="margin-top: 35px">
    									...
    									<a
    										href="/spaces/index.php"
    										class="ws-hover-text-green"
    										style="color: #04aa6d"
    										>W3Schools Spaces</a
    									>.
    								</h3>
    								<h5 style="margin-top: 25px">
    									No installation required - just open your browser and start
    									coding:
    								</h5>
    								<br />
    								<picture>
    									<source
    										srcset="/spaces/dynamicspaces.webp"
    										type="image/webp"
    										style="
    								...
    								<a
    									...
    									style="
    										...
    										padding: 11px 18px;
    									"
    									title="Learn more about W3Schools Spaces"
    									>Learn More</a
    								><br />
    							</div>
    						</div>
    						...
    						<div class="pro-caption ws-black">
    							...
    							<div style="text-align: center; margin: auto">
    								<ul style="display: inline-block">
    									<li>
    										<img
    											src="/spaces/files/check3.db67d31e.svg"
    											style="margin-right: 15px"
    											alt="Checkmark" />Browse W3Schools
    									...
    									<li>
    										<img
    											src="/spaces/files/check3.db67d31e.svg"
    											style="margin-right: 15px"
    											alt="Checkmark" />Build and host Websites
    									</li>
    									<li>
    										<img
    											src="/spaces/files/check3.db67d31e.svg"
    											style="margin-right: 15px"
    											alt="Checkmark" />Unlimited challenges
    									</li>
    									<li>
    										<img
    											src="/spaces/files/check3.db67d31e.svg"
    											style="margin-right: 15px"
    											alt="Checkmark" />Unlimited practice tests
    									</li>
    									<li>
    										<img
    											src="/spaces/files/check3.db67d31e.svg"
    											style="margin-right: 15px"
    											alt="Checkmark" />Get extra credits
    									</li>
    									<li>
    										<img
    											src="/spaces/files/check3.db67d31e.svg"
    											style="margin-right: 15px"
    											alt="Checkmark" />Priority support
    									</li>
    								</ul>
    							</div>
    							<a
    								href="https://order.w3schools.com/plans"
    								class="ws-btn tut-button ga-fp"
    								style="
    									margin-top: 35px;
    									font-size: 20px;
    									width: 300px;
    								...
    								"
    								id="proFromDefault"
    								title="Learn more about W3Schools Plus"
    								target="_blank"
    								>Learn More</a
    							><br />
    						</div>
    										...
    										<ul style="display: inline-block">
    											<li>
    												<img
    													src="/spaces/files/check3.db67d31e.svg"
    													style="margin-right: 15px"
    													alt="Checkmark" />Manage your classroom
    											</li>
    											<li>
    												<img
    													src="/spaces/files/check3.db67d31e.svg"
    													style="margin-right: 15px"
    													alt="Checkmark" />Ready-to-use learning materials
    											</li>
    											<li>
    												<img
    													src="/spaces/files/check3.db67d31e.svg"
    													style="margin-right: 15px"
    													alt="Checkmark" />Customize study plans
    											</li>
    											<li>
    												<img
    													src="/spaces/files/check3.db67d31e.svg"
    													style="margin-right: 15px"
    													alt="Checkmark" />Track student progress
    											</li>
    											<li>
    												<img
    													src="/spaces/files/check3.db67d31e.svg"
    													style="margin-right: 15px"
    													alt="Checkmark" />Interactive coding challenges
    											</li>
    										</ul>
    									</div>
    									<a
    						...
    						<div
    							...
    							<div class="w3-content">
    								...
    								<a
    									href="/colors/colors_picker.asp"
    									class="w3-hover-opacity ga-fp">
    									<picture>
    										<source
    											srcset="/images/colorpicker.webp"
    											type="image/webp"
    							...
    							<div class="w3-col l12 w3-center" style="padding: 3%">
    								...
    								<a
    									...
    									<picture>
    										<source
    											style="margin: 16px 0"
    											srcset="/images/w3lynx_200.webp"
    											type="image/webp" />
    										<img
    											style="margin: 16px 0"
    											src="/images/w3lynx_200.png"
    											alt="Code Game"
    											loading="lazy" />
    									</picture>
    								</a>
    								<p>
    									<a
    										class="w3-button ga-fp tut-button black-color"
    										href="/codegame/index.html"
    										target="_blank"
    										style="font-size: 20px; padding: 11px 18px"
    										>Play Game</a
    									>
    								</p>
    							</div>
    						...
    						<div
    							class="w3-center w3-padding-64 ws-black"
    							style="
    								padding-left: 20px;
    								padding-right: 20px;
    							...
    							<br />
    							<div
    								class="w3-row-padding w3-content"
    								style="max-width: 1352px">
    								<div class="w3-half">
    									<p>
    										<a
    											class="w3-button ga-fp exercise-button w3-round ws-green"
    											href="/exercises/index.php"
    											>Exercises</a
    										>
    									</p>
    								...
    								<div class="w3-half">
    									<p>
    										<a
    											class="w3-button ga-fp exercise-button w3-round ws-yellow hover-yellow"
    											href="/quiztest/default.asp"
    											>Quizzes</a
    										>
    									</p>
    						...
    						<div
    							class="w3-center ws-grey"
    							style="padding: 64px 24px 90px 24px">
    							<h1 style="font-size: 65px; font-weight: 700">Web Templates</h1>
    							<br />
    							<h4>
    							...
    							<div class="w3-content">
    								<a href="/w3css/w3css_templates.asp">
    									<picture>
    										<source
    											srcset="w3css_templates.webp"
    											type="image/webp"
    											style="width: 100%; margin: 16px 0 20px 0" />
    										<img
    						...
    						<div
    							...
    							">
    							<div
    								style="max-width: 1225px; margin: auto; position: relative">
    								...
    								<svg
    									...
    									<circle
    										...
    										cy="150"
    										r="146.47"
    										transform="translate(-62.13 150) rotate(-45)"></circle>
    									<text
    										class="cls-2"
    									...
    									<text
    										class="cls-3"
    										transform="translate(35.51 186.66) rotate(69.37)"></text>
    									<text
    										class="cls-3"
    									...
    									<text
    										class="cls-3"
    										transform="translate(155.7 270.01) rotate(-5.58)"></text>
    									<text
    										class="cls-3"
    										transform="translate(171.32 268.24) rotate(-13.06)"></text>
    									<text
    										class="cls-2"
    									...
    									<text
    										class="cls-3"
    										transform="translate(203.27 257.7) rotate(-29.24)"></text>
    									<text
    										class="cls-3"
    										transform="translate(216.84 249.83) rotate(-36.75)"></text>
    									<text
    										class="cls-3"
    									...
    									<path
    										class="cls-4"
    										d="M196.64,136.31s3.53,3.8,8.5,3.8c3.9,0,6.75-2.37,6.75-5.59,0-4-3.64-5.81-8-5.81h-2.59l-1.53-3.48,6.86-8.13a34.07,34.07,0,0,1,2.7-2.85s-1.11,0-3.33,0H194.79v-5.86H217.7v4.28l-9.19,10.61c5.18.74,10.24,4.43,10.24,10.92s-4.85,12.3-13.19,12.3a17.36,17.36,0,0,1-12.41-5Z"></path>
    									<path
    										class="cls-4"
    										d="M152,144.24l30.24,53.86,14.94-26.61L168.6,120.63H135.36l-13.78,24.53-13.77-24.53H77.93l43.5,77.46.15-.28.16.28Z"></path>
    								</svg>
    							</div>
    						</div>
    								...
    								<div class="codeeditorbr-row">
    									...
    									<div class="codeeditorbr-column codeeditorbr-middle">
    										<input
    											...
    											disabled=""
    											class="codeeditorbr-input"
    											value="www.w3schools.com/howto/"
    											aria-label="Select template" />
    									</div>
    								</div>
    								<iframe
    									src="/howto/tryhow_js_slideshow_ifr.htm"
    									id="howto_iframe"
    									title="How To Selection"></iframe>
    							</div>
    						...
    						<script>
    							function openLangTab(evtEd, codeName) {
    								...
    								for (
    									indexEditor = 0;
    									indexEditor < proglanguage.length;
    									indexEditor++
    								) {
    									proglanguage[indexEditor].style.display = "none";
    								}
    								progtablinks = document.getElementsByClassName(
    									"codeeditorbr-tablink",
    								);
    								for (
    									indexEditor = 0;
    									...
    									progtablinks[indexEditor].className = progtablinks[
    										indexEditor
    									].className.replace(" ws-grey", "");
    								}
...
["", "/sass/sass_functions_string.asp", "Sass Reference"],
...
["js certificate", "https://campus.w3schools.com/collections/certifications/products/javascript-certificate", "JavaScript Certificate"],  
 ...
 ["website", "/spaces/index.php", "Website Hosting with W3Schools Spaces"],  
 ["plus", "https://order.w3schools.com/plans", "W3Schools Plus User"],
["upgrade", "https://order.w3schools.com/plans", "W3Schools Plus User"],
["ad free", "https://order.w3schools.com/plans", "W3Schools without ads"],
...
if (
searchArray[i][0].toUpperCase().substr(0, val.length) ==
val ||
searchArray[i][2].toUpperCase().substr(0, val.length) ==
val
) {
...
for (i = 0; i < searchArray.length; i++) {
if (
resultIndexes.indexOf(i) == -1 &&
(searchArray[i][0].toUpperCase().indexOf(val) > -1 ||
searchArray[i][2].toUpperCase().indexOf(val) > -1)
) {
if (resultTexts.indexOf(searchArray[i][2]) == -1) {
resultIndexes.push(i);
resultTexts.push(searchArray[i][2]);
...
"<a class='search_item" +
											classAtt +
											"' onclick='click_search_w3schools_link(event)' href='search_entire_w3schools'>Search W3Schools</a>";
}
a.innerHTML = html;
}
...
window.location = n;
    							...
    							function execute_google_search() {
    								if (typeof google == "object") {
    									google.search.cse.element
    										...
    										.execute(document.getElementById("search2").value);
    								} else {
    							...
    							document.body.addEventListener("click", function (event) {
    								...
    								if (
    									x.id == "search2" ||
    									x.id == "learntocode_searchbtn" ||
    									x.id == "learntocode_searchicon" ||
    									x.classList.contains("search_item")
    								) {
    								} else {
    									a = document.getElementById("listofsearchresults");
    									a.innerHTML = "";
    						...
    						<div
    							...
    							<div class="w3s-pathfinder -teaser user-anonymous">
    								<div class="track-progress-btn-wrapper">
    									<a
    										href="https://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fpathfinder.w3schools.com&amp;origin=https%3A%2F%2Fwww.w3schools.com%2F"
    		...
    		<div
    			id="footer"
    			class="footer w3-container w3-white"
    			style="border-top: 0">
...
background-position: right bottom;_/
}
#spacemyfooter {
...
<a
								href="https://order.w3schools.com/plans"
								title="Become a PLUS user and unlock powerful features"
								class="ga-bottom ga-bottom-plus"
								target="_blank"
								>PLUS</a
							>
</div>
...
<a
								href="/spaces/index.php"
								title="Get your own website with W3Schools Spaces"
								class="ga-bottom ga-bottom-spaces"
								>SPACES</a
							>
</div>
<div class="footerlinks_1">
<a
								href="https://campus.w3schools.com/collections/certifications"
								title="Document your knowledge by getting certified"
								target="_blank"
								class="ga-bottom ga-bottom-cert"
								>GET CERTIFIED</a
							>
</div>
<div class="footerlinks_1">
<a
								href="/academy/index.php"
								title="Contact us about W3Schools Academy for educational institutions"
								class="ga-bottom ga-bottom-teachers"
								>FOR TEACHERS</a
							>
</div>
<div class="footerlinks_1">
<a href="/bootcamp/index.php" title="W3Schools Bootcamps"
								>BOOTCAMPS</a
							>
</div>
<div class="footerlinks_1">
<a
								href="javascript:void(0);"
								title="Contact us about sales or errors"
								onclick="
									reportError();
									return false;
								"
...
border-radius: 50%;
    				...
    				<div id="err_message">
    					<span
    						id="close_err_message"
    						onclick="this.parentElement.style.display = 'none'"
    						>×</span
    					>
    					<h2>Contact Sales</h2>
    					<p>
    						If you want to use W3Schools services as an educational
    						institution, team or enterprise, send us an e-mail:<br />sales@w3schools.com
    					</p>
    					<h2>Report Error</h2>
    					<p>
    						If you want to report an error, or if you want to make a
    						suggestion, send us an e-mail:<br />help@w3schools.com
    					</p>
    				</div>
    				...
    				<div style="overflow: hidden">
    					<div class="footerlinks_2">
    						...
    						<a href="/html/default.asp" class="ga-bottom">HTML Tutorial</a
    						><br />
    						<a href="/css/default.asp" class="ga-bottom">CSS Tutorial</a
    						><br />
    						<a href="/js/default.asp" class="ga-bottom">JavaScript Tutorial</a
    						><br />
    						<a href="/howto/default.asp" class="ga-bottom">How To Tutorial</a
    						><br />
    						<a href="/sql/default.asp" class="ga-bottom">SQL Tutorial</a
    						><br />
    						<a href="/python/default.asp" class="ga-bottom">Python Tutorial</a
    						><br />
    						<a href="/w3css/default.asp" class="ga-bottom">W3.CSS Tutorial</a
    						><br />
    						<a href="/bootstrap/bootstrap_ver.asp" class="ga-bottom"
    							>Bootstrap Tutorial</a
    						><br />
    						<a href="/php/default.asp" class="ga-bottom">PHP Tutorial</a
    						><br />
    						<a href="/java/default.asp" class="ga-bottom">Java Tutorial</a
    						><br />
    						<a href="/cpp/default.asp" class="ga-bottom">C++ Tutorial</a
    						><br />
    						<a href="/jquery/default.asp" class="ga-bottom">jQuery Tutorial</a
    						><br />
    					</div>
    					<div class="footerlinks_2">
    						<h5 style="font-family: &quot;Source Sans Pro&quot;, sans-serif">
    						...
    						<a href="/tags/default.asp" class="ga-bottom">HTML Reference</a
    						><br />
    						<a href="/cssref/index.php" class="ga-bottom">CSS Reference</a
    						><br />
    						<a href="/jsref/default.asp" class="ga-bottom"
    							>JavaScript Reference</a
    						><br />
    						<a href="/sql/sql_ref_keywords.asp" class="ga-bottom"
    							>SQL Reference</a
    						><br />
    						<a href="/python/python_reference.asp" class="ga-bottom"
    							>Python Reference</a
    						><br />
    						<a href="/w3css/w3css_references.asp" class="ga-bottom"
    							>W3.CSS Reference</a
    						><br />
    						<a
    							href="/bootstrap/bootstrap_ref_all_classes.asp"
    							class="ga-bottom"
    							>Bootstrap Reference</a
    						><br />
    						<a href="/php/php_ref_overview.asp" class="ga-bottom"
    							>PHP Reference</a
    						><br />
    						<a href="/colors/colors_names.asp" class="ga-bottom"
    							>HTML Colors</a
    						><br />
    						<a href="/java/java_ref_keywords.asp" class="ga-bottom"
    							>Java Reference</a
    						><br />
    						<a
    							href="/angularjs/angularjs_ref_directives.asp"
    							class="ga-bottom"
    							>AngularJS Reference</a
    						><br />
    						<a href="/jquery/jquery_ref_overview.asp" class="ga-bottom"
    							>jQuery Reference</a
    						><br />
    					</div>
    					<div class="footerlinks_2">
    						...
    						<a href="/html/html_examples.asp" class="ga-bottom"
    							>HTML Examples</a
    						><br />
    						<a href="/css/css_examples.asp" class="ga-bottom">CSS Examples</a
    						><br />
    						<a href="/js/js_examples.asp" class="ga-bottom"
    							>JavaScript Examples</a
    						><br />
    						<a href="/howto/default.asp" class="ga-bottom">How To Examples</a
    						><br />
    						<a href="/sql/sql_examples.asp" class="ga-bottom">SQL Examples</a
    						><br />
    						<a href="/python/python_examples.asp" class="ga-bottom"
    							>Python Examples</a
    						><br />
    						<a href="/w3css/w3css_examples.asp" class="ga-bottom"
    							>W3.CSS Examples</a
    						><br />
    						<a href="/bootstrap/bootstrap_examples.asp" class="ga-bottom"
    							>Bootstrap Examples</a
    						><br />
    						<a href="/php/php_examples.asp" class="ga-bottom">PHP Examples</a
    						><br />
    						<a href="/java/java_examples.asp" class="ga-bottom"
    							>Java Examples</a
    						><br />
    						<a href="/xml/xml_examples.asp" class="ga-bottom">XML Examples</a
    						><br />
    						<a href="/jquery/jquery_examples.asp" class="ga-bottom"
    							>jQuery Examples</a
    						><br />
    					</div>
    					<div class="footerlinks_2">
    				...
    				<div class="footersome">
    					...
    					<a
    						target="_blank"
    						href="/academy/index.php"
    						title="Contact us about W3Schools Academy for educational institutions and organizations"
    						class="textlink ga-bottom-textlink-academy"
    						>ACADEMY</a
    					>
    				</div>
    				...
    				<div class="footertext">
    					...
    					simplified to improve reading and learning.<br
    						class="footer-hide-special" />
    					Tutorials, references, and examples are constantly reviewed to avoid
    					errors, but we cannot warrant full correctness<br
    						class="footer-hide-special" />
    					of all content. While using W3Schools, you agree to have read and
    					accepted our
    					<a href="/about/about_copyright.asp" class="ga-bottom"
    						>terms of use</a
    					>,
    					<a
    						style="cursor: pointer; text-decoration: underline"
    						onclick="window.FastCMP.open()"
    						class="ga-bottom"
    						>cookies</a
    					>
    					and
    					<a href="/about/about_privacy.asp" class="ga-bottom"
    						>privacy policy</a
    					>.<br /><br />
    					<a href="/about/about_copyright.asp" class="ga-bottom"
    						>Copyright 1999-2026</a
    					>
    					by Refsnes Data. All Rights Reserved.
    					<a href="//www.w3schools.com/w3css/default.asp" class="ga-bottom"
    						>W3Schools is Powered by W3.CSS</a
    					>.<br /><br />
    				</div>
    			</div>
    		</div>
    	...
    	<script>
    		...
    		const upperfeatureshowcaselink = document.getElementById(
...
<div id="aiFabShadowRoot" data-fab-type="react" style="opacity: 1">
<template shadowrootmode="open"
			><div id="fab-react-root">
<div class="fab-root">
<div class="acrobat-button-container" style="bottom: 36px">
<div
							class="acrobat-button"
							role="button"
							aria-label="Get summaries and key insights using AI Assistant">
...
<path
											d="M7.82482 7.00034L10.6374 4.18778C10.7893 4.03592 10.7893 3.78969 10.6374 3.63783L10.3625 3.36292C10.2106 3.21106 9.96446 3.21106 9.81255 3.36292L6.99995 6.17548L4.18734 3.36292C4.03543 3.21106 3.78933 3.21106 3.63743 3.36292L3.36247 3.63783C3.21056 3.78969 3.21056 4.03592 3.36247 4.18778L6.17507 7.00034L3.36247 9.81295C3.21056 9.96481 3.21056 10.2111 3.36247 10.3629L3.63743 10.6378C3.78933 10.7897 4.03543 10.7897 4.18734 10.6378L6.99995 7.82526L9.81255 10.6378C9.96446 10.7897 10.2106 10.7897 10.3625 10.6378L10.6374 10.3629C10.7893 10.2111 10.7893 9.96481 10.6374 9.81295L7.82482 7.00034Z"
											fill="#222222"></path>
</mask>
...
<mask
										...
										style="mask-type: alpha">
<path
											d="M15.1285 12.8008H6.37852C6.08867 12.8008 5.85352 13.0359 5.85352 13.3258C5.85352 13.6156 6.08867 13.8508 6.37852 13.8508H15.1285C15.4184 13.8508 15.6535 13.6156 15.6535 13.3258C15.6535 13.0359 15.4184 12.8008 15.1285 12.8008Z"
											fill="#292929"></path>
<path
											d="M6.37852 6.85078H15.1285C15.4184 6.85078 15.6535 6.61562 15.6535 6.32578C15.6535 6.03594 15.4184 5.80078 15.1285 5.80078H6.37852C6.08867 5.80078 5.85352 6.03594 5.85352 6.32578C5.85352 6.61562 6.08867 6.85078 6.37852 6.85078Z"
											fill="#292929"></path>
<path
											d="M15.1285 9.30078H6.37852C6.08867 9.30078 5.85352 9.53594 5.85352 9.82578C5.85352 10.1156 6.08867 10.3508 6.37852 10.3508H15.1285C15.4184 10.3508 15.6535 10.1156 15.6535 9.82578C15.6535 9.53594 15.4184 9.30078 15.1285 9.30078Z"
											fill="#292929"></path>
</mask>
...
<path
							...
							><span class="tooltip-text-content"
								>Check out Acrobat's new home in your browser</span
							>
</div>
...
<svg
								...
								xmlns="http://www.w3.org/2000/svg">
<path
									d="M4.60039 13.0699C5.26313 13.0699 5.80039 12.5327 5.80039 11.8699C5.80039 11.2072 5.26313 10.6699 4.60039 10.6699C3.93765 10.6699 3.40039 11.2072 3.40039 11.8699C3.40039 12.5327 3.93765 13.0699 4.60039 13.0699Z"
									fill="#292929"></path>
<path
									d="M4.60039 8.27109C5.26313 8.27109 5.80039 7.73384 5.80039 7.07109C5.80039 6.40835 5.26313 5.87109 4.60039 5.87109C3.93765 5.87109 3.40039 6.40835 3.40039 7.07109C3.40039 7.73384 3.93765 8.27109 4.60039 8.27109Z"
									fill="#292929"></path>
<path
									d="M4.60039 3.47031C5.26313 3.47031 5.80039 2.93305 5.80039 2.27031C5.80039 1.60757 5.26313 1.07031 4.60039 1.07031C3.93765 1.07031 3.40039 1.60757 3.40039 2.27031C3.40039 2.93305 3.93765 3.47031 4.60039 3.47031Z"
									fill="#292929"></path>
<path
									d="M9.4002 13.0699C10.0629 13.0699 10.6002 12.5327 10.6002 11.8699C10.6002 11.2072 10.0629 10.6699 9.4002 10.6699C8.73745 10.6699 8.2002 11.2072 8.2002 11.8699C8.2002 12.5327 8.73745 13.0699 9.4002 13.0699Z"
									fill="#292929"></path>
<path
									d="M9.4002 8.27109C10.0629 8.27109 10.6002 7.73384 10.6002 7.07109C10.6002 6.40835 10.0629 5.87109 9.4002 5.87109C8.73745 5.87109 8.2002 6.40835 8.2002 7.07109C8.2002 7.73384 8.73745 8.27109 9.4002 8.27109Z"
									fill="#292929"></path>
<path
									d="M9.4002 3.47031C10.0629 3.47031 10.6002 2.93305 10.6002 2.27031C10.6002 1.60757 10.0629 1.07031 9.4002 1.07031C8.73745 1.07031 8.2002 1.60757 8.2002 2.27031C8.2002 2.93305 8.73745 3.47031 9.4002 3.47031Z"
									fill="#292929"></path>
</svg>
</div>
</div>
...
transition: opacity 0.3s ease-in-out;
    			...
    			.fab-home-tooltip {
    				...
    				box-shadow:
    					...
    					0px 3px 5px rgba(116, 23, 208, 0.07);
    			}
    			...
    			@font-face {
    				...
    				font-weight: 400;
    				src: url("chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/browser/css/fonts/AdobeClean-Regular.otf")
    					format("opentype");
    			}
    			@font-face {
    				font-family: "adobe-clean";
    				font-weight: 700;
    				src: url("chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/browser/css/fonts/AdobeClean-Bold.otf")
    					format("opentype");
    			}
    			@font-face {
    			...
    			body {
    				font-family:
    					"AdobeClean-Regular", adobe-clean, "Adobe Clean", sans-serif;
    			}
    			...
    			.fab-fte-background {
    				...
    				width: 183.33px;
    				height: 126.82px;
    				background: url("chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/browser/images/fab-header-background.svg")
    					no-repeat center;
    			...
    			.fab-pill-icon img {
    				...
    				filter: brightness(0) saturate(100%) invert(13%) sepia(0%)
    					saturate(0%) hue-rotate(196deg) brightness(97%) contrast(97%); /* #222222 */
    			}
